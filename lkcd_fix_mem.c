...
int fix_addr_v8(dump_header_asm_t * dha)
{
	fix_addr(dha);
...
static int fix_addr(dump_header_asm_t * dha)
{
...
ulong get_lkcd_switch_stack(ulong task)
{
	int i;
