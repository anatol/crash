...
static int vm_area_page_dump(ulong, ulong, ulong, ulong, ulong, struct reference *);
...
void vm_init(void)
{
	...
	MEMBER_OFFSET_INIT(vm_area_struct_vm_start, "vm_area_struct", "vm_start");
	MEMBER_OFFSET_INIT(vm_area_struct_vm_flags, "vm_area_struct", "vm_flags");
	MEMBER_OFFSET_INIT(vm_area_struct_vm_file, "vm_area_struct", "vm_file");
	MEMBER_OFFSET_INIT(vm_area_struct_vm_offset, "vm_area_struct", "vm_offset");
	MEMBER_OFFSET_INIT(vm_area_struct_vm_pgoff, "vm_area_struct", "vm_pgoff");
	...
	if (VALID_MEMBER(vmap_area_va_start) &&
	    ...
	    VALID_MEMBER(vmap_area_flags) && VALID_MEMBER(vmap_area_list) && VALID_MEMBER(vmap_area_vm)
	...
	if (VALID_MEMBER(page_list)) {
		ASSIGN_OFFSET(page_list_next) = OFFSET(page_list) + OFFSET(list_head_next);
		ASSIGN_OFFSET(page_list_prev) = OFFSET(page_list) + OFFSET(list_head_prev);
	}
	...
	if (INVALID_MEMBER(page_mapping) &&
	    (THIS_KERNEL_VERSION < LINUX(2, 6, 17)) && MEMBER_EXISTS("page", "_mapcount"))
		ASSIGN_OFFSET(page_mapping) =
		    MEMBER_OFFSET("page", "_mapcount") + STRUCT_SIZE("atomic_t") + sizeof(ulong);
	...
	MEMBER_OFFSET_INIT(swap_info_struct_swap_file, "swap_info_struct", "swap_file");
	MEMBER_OFFSET_INIT(swap_info_struct_swap_vfsmnt, "swap_info_struct", "swap_vfsmnt");
	MEMBER_OFFSET_INIT(swap_info_struct_flags, "swap_info_struct", "flags");
	MEMBER_OFFSET_INIT(swap_info_struct_swap_map, "swap_info_struct", "swap_map");
	MEMBER_OFFSET_INIT(swap_info_struct_swap_device, "swap_info_struct", "swap_device");
	...
	MEMBER_OFFSET_INIT(swap_info_struct_inuse_pages, "swap_info_struct", "inuse_pages");
	MEMBER_OFFSET_INIT(swap_info_struct_old_block_size, "swap_info_struct", "old_block_size");
	...
	if (VALID_STRUCT(blk_major_name)) {
		MEMBER_OFFSET_INIT(blk_major_name_next, "blk_major_name", "next");
		MEMBER_OFFSET_INIT(blk_major_name_name, "blk_major_name", "name");
		MEMBER_OFFSET_INIT(blk_major_name_major, "blk_major_name", "major");
	}
	...
	if (!VALID_STRUCT(kmem_slab_s) && VALID_STRUCT(slab_s)) {
		...
		MEMBER_OFFSET_INIT(kmem_cache_s_objsize, "kmem_cache_s", "objsize");
		MEMBER_OFFSET_INIT(kmem_cache_s_flags, "kmem_cache_s", "flags");
		MEMBER_OFFSET_INIT(kmem_cache_s_gfporder, "kmem_cache_s", "gfporder");
		MEMBER_OFFSET_INIT(kmem_cache_s_slabs, "kmem_cache_s", "slabs");
		MEMBER_OFFSET_INIT(kmem_cache_s_slabs_full, "kmem_cache_s", "slabs_full");
		MEMBER_OFFSET_INIT(kmem_cache_s_slabs_partial, "kmem_cache_s", "slabs_partial");
		MEMBER_OFFSET_INIT(kmem_cache_s_slabs_free, "kmem_cache_s", "slabs_free");
		MEMBER_OFFSET_INIT(kmem_cache_s_cpudata, "kmem_cache_s", "cpudata");
		ARRAY_LENGTH_INIT(len, NULL, "kmem_cache_s.cpudata", NULL, 0);
		MEMBER_OFFSET_INIT(kmem_cache_s_colour_off, "kmem_cache_s", "colour_off");
	...
	} else if (!VALID_STRUCT(kmem_slab_s) && !VALID_STRUCT(slab_s) && VALID_STRUCT(slab)) {
		...
		if (VALID_STRUCT(kmem_cache_s)) {
			...
			MEMBER_OFFSET_INIT(kmem_cache_s_colour_off, "kmem_cache", "colour_off");
			if (MEMBER_EXISTS("kmem_cache", "objsize"))
				MEMBER_OFFSET_INIT(kmem_cache_s_objsize, "kmem_cache", "objsize");
			else if (MEMBER_EXISTS("kmem_cache", "buffer_size"))
				MEMBER_OFFSET_INIT(kmem_cache_s_objsize, "kmem_cache", "buffer_size");
			else if (MEMBER_EXISTS("kmem_cache", "size"))
				MEMBER_OFFSET_INIT(kmem_cache_s_objsize, "kmem_cache", "size");
			MEMBER_OFFSET_INIT(kmem_cache_s_flags, "kmem_cache", "flags");
			MEMBER_OFFSET_INIT(kmem_cache_s_gfporder, "kmem_cache", "gfporder");
			...
			if (MEMBER_EXISTS("kmem_cache", "lists"))
				...
				if (MEMBER_TYPE("kmem_cache", "nodelists") == TYPE_CODE_PTR) {
					...
					if (kernel_symbol_exists("nr_node_ids")) {
						get_symbol_data("nr_node_ids", sizeof(int), &nr_node_ids);
						vt->kmem_cache_len_nodes = nr_node_ids;
					} else
						vt->kmem_cache_len_nodes = 1;
				} else
					ARRAY_LENGTH_INIT(vt->kmem_cache_len_nodes,
							  NULL, "kmem_cache.nodelists", NULL, 0);
			}
		...
		MEMBER_OFFSET_INIT(kmem_list3_slabs_partial, "kmem_list3", "slabs_partial");
		MEMBER_OFFSET_INIT(kmem_list3_slabs_full, "kmem_list3", "slabs_full");
		MEMBER_OFFSET_INIT(kmem_list3_slabs_free, "kmem_list3", "slabs_free");
		MEMBER_OFFSET_INIT(kmem_list3_free_objects, "kmem_list3", "free_objects");
		MEMBER_OFFSET_INIT(kmem_list3_shared, "kmem_list3", "shared");
	} else if (MEMBER_EXISTS("kmem_cache", "cpu_slab") && STRUCT_EXISTS("kmem_cache_node")) {
		...
		if (INVALID_MEMBER(kmem_cache_objsize))
			MEMBER_OFFSET_INIT(kmem_cache_objsize, "kmem_cache", "object_size");
		...
		MEMBER_OFFSET_INIT(kmem_cache_node_nr_partial, "kmem_cache_node", "nr_partial");
		MEMBER_OFFSET_INIT(kmem_cache_node_nr_slabs, "kmem_cache_node", "nr_slabs");
		MEMBER_OFFSET_INIT(kmem_cache_node_partial, "kmem_cache_node", "partial");
		MEMBER_OFFSET_INIT(kmem_cache_node_full, "kmem_cache_node", "full");
	} else {
		MEMBER_OFFSET_INIT(kmem_cache_s_c_nextp, "kmem_cache_s", "c_nextp");
		MEMBER_OFFSET_INIT(kmem_cache_s_c_name, "kmem_cache_s", "c_name");
		MEMBER_OFFSET_INIT(kmem_cache_s_c_num, "kmem_cache_s", "c_num");
		MEMBER_OFFSET_INIT(kmem_cache_s_c_org_size, "kmem_cache_s", "c_org_size");
		MEMBER_OFFSET_INIT(kmem_cache_s_c_flags, "kmem_cache_s", "c_flags");
		MEMBER_OFFSET_INIT(kmem_cache_s_c_offset, "kmem_cache_s", "c_offset");
		MEMBER_OFFSET_INIT(kmem_cache_s_c_firstp, "kmem_cache_s", "c_firstp");
		MEMBER_OFFSET_INIT(kmem_cache_s_c_gfporder, "kmem_cache_s", "c_gfporder");
		MEMBER_OFFSET_INIT(kmem_cache_s_c_magic, "kmem_cache_s", "c_magic");
		MEMBER_OFFSET_INIT(kmem_cache_s_c_align, "kmem_cache_s", "c_align");

		MEMBER_OFFSET_INIT(kmem_slab_s_s_nextp, "kmem_slab_s", "s_nextp");
		MEMBER_OFFSET_INIT(kmem_slab_s_s_freep, "kmem_slab_s", "s_freep");
		MEMBER_OFFSET_INIT(kmem_slab_s_s_inuse, "kmem_slab_s", "s_inuse");
		MEMBER_OFFSET_INIT(kmem_slab_s_s_mem, "kmem_slab_s", "s_mem");
		MEMBER_OFFSET_INIT(kmem_slab_s_s_index, "kmem_slab_s", "s_index");
		MEMBER_OFFSET_INIT(kmem_slab_s_s_offset, "kmem_slab_s", "s_offset");
		MEMBER_OFFSET_INIT(kmem_slab_s_s_magic, "kmem_slab_s", "s_magic");
	}
	...
	if (CRASHDEBUG(1))
		fprintf(fp, "kernel NR_CPUS: %d %s\n", kt->kernel_NR_CPUS, kt->kernel_NR_CPUS ? "" : "(unknown)");
	...
	if (machdep->init_kernel_pgd)
		...
		if ((len == NR_CPUS) && (dimension == machdep->ptrs_per_pgd)) {
			...
			for (i = 0; i < NR_CPUS; i++) {
				value2 = i * (SIZE(pgd_t) * machdep->ptrs_per_pgd);
				vt->kernel_pgd[i] = value1 + value2;
			}
			error(WARNING, "no swapper_pg_dir: using first entry of cpu_pgd[%d][%d]\n\n", dimension, len);
		} else {
			error(WARNING, "unrecognized dimensions: cpu_pgd[%d][%d]\n", dimension, len);
			value1 = symbol_value("cpu_pgd");
			for (i = 0; i < NR_CPUS; i++)
				vt->kernel_pgd[i] = value1;
			error(WARNING, "no swapper_pg_dir: using first entry of cpu_pgd[%d][%d]\n\n", dimension, len);
	...
	case 1:
		get_symbol_data("totalram_pages", sizeof(ulong), &vt->totalram_pages);
		break;
	case 2:
		if (!(readmem(sp_array[0]->value, KVADDR,
			      &value1, sizeof(ulong), "totalram_pages #1", RETURN_ON_ERROR)))
			break;
		if (!(readmem(sp_array[1]->value, KVADDR,
			      &value2, sizeof(ulong), "totalram_pages #2", RETURN_ON_ERROR)))
			break;
	...
	if (symbol_exists("totalhigh_pages")) {
		...
		case 1:
			get_symbol_data("totalhigh_pages", sizeof(ulong), &vt->totalhigh_pages);
			break;
		case 2:
			if (!(readmem(sp_array[0]->value, KVADDR,
				      &value1, sizeof(ulong), "totalhigh_pages #1", RETURN_ON_ERROR)))
				break;
			if (!(readmem(sp_array[1]->value, KVADDR,
				      &value2, sizeof(ulong), "totalhigh_pages #2", RETURN_ON_ERROR)))
				break;
	...
	if (symbol_exists("num_physpages"))
		get_symbol_data("num_physpages", sizeof(ulong), &vt->num_physpages);

	if (kernel_symbol_exists("mem_map"))
		get_symbol_data("max_mapnr", sizeof(ulong), &vt->max_mapnr);
	if (kernel_symbol_exists("nr_swapfiles"))
		get_symbol_data("nr_swapfiles", sizeof(unsigned int), &vt->nr_swapfiles);
	...
	if (VALID_STRUCT(pglist_data)) {
		...
		MEMBER_OFFSET_INIT(pglist_data_node_zones, "pglist_data", "node_zones");
		MEMBER_OFFSET_INIT(pglist_data_node_mem_map, "pglist_data", "node_mem_map");
		MEMBER_OFFSET_INIT(pglist_data_node_start_paddr, "pglist_data", "node_start_paddr");
		MEMBER_OFFSET_INIT(pglist_data_node_start_mapnr, "pglist_data", "node_start_mapnr");
		MEMBER_OFFSET_INIT(pglist_data_node_size, "pglist_data", "node_size");
		MEMBER_OFFSET_INIT(pglist_data_node_id, "pglist_data", "node_id");
		MEMBER_OFFSET_INIT(pglist_data_node_next, "pglist_data", "node_next");
		MEMBER_OFFSET_INIT(pglist_data_bdata, "pglist_data", "bdata");
		MEMBER_OFFSET_INIT(pglist_data_nr_zones, "pglist_data", "nr_zones");
		MEMBER_OFFSET_INIT(pglist_data_node_start_pfn, "pglist_data", "node_start_pfn");
		MEMBER_OFFSET_INIT(pglist_data_pgdat_next, "pglist_data", "pgdat_next");
		MEMBER_OFFSET_INIT(pglist_data_node_present_pages, "pglist_data", "node_present_pages");
		MEMBER_OFFSET_INIT(pglist_data_node_spanned_pages, "pglist_data", "node_spanned_pages");
		ARRAY_LENGTH_INIT(vt->nr_zones, pglist_data_node_zones,
				  "pglist_data.node_zones", NULL, SIZE_OPTION(zone_struct, zone));
		vt->ZONE_HIGHMEM = vt->nr_zones - 1;

		if (VALID_STRUCT(zone_struct)) {
			MEMBER_OFFSET_INIT(zone_struct_free_pages, "zone_struct", "free_pages");
			MEMBER_OFFSET_INIT(zone_struct_free_area, "zone_struct", "free_area");
			MEMBER_OFFSET_INIT(zone_struct_zone_pgdat, "zone_struct", "zone_pgdat");
			MEMBER_OFFSET_INIT(zone_struct_name, "zone_struct", "name");
			MEMBER_OFFSET_INIT(zone_struct_size, "zone_struct", "size");
			if (INVALID_MEMBER(zone_struct_size))
				MEMBER_OFFSET_INIT(zone_struct_memsize, "zone_struct", "memsize");
			MEMBER_OFFSET_INIT(zone_struct_zone_start_pfn, "zone_struct", "zone_start_pfn");
			MEMBER_OFFSET_INIT(zone_struct_zone_start_paddr, "zone_struct", "zone_start_paddr");
			MEMBER_OFFSET_INIT(zone_struct_zone_start_mapnr, "zone_struct", "zone_start_mapnr");
			MEMBER_OFFSET_INIT(zone_struct_zone_mem_map, "zone_struct", "zone_mem_map");
			MEMBER_OFFSET_INIT(zone_struct_inactive_clean_pages, "zone_struct", "inactive_clean_pages");
			MEMBER_OFFSET_INIT(zone_struct_inactive_clean_list, "zone_struct", "inactive_clean_list");
			ARRAY_LENGTH_INIT(vt->nr_free_areas,
					  zone_struct_free_area, "zone_struct.free_area", NULL, SIZE(free_area_struct));
			MEMBER_OFFSET_INIT(zone_struct_inactive_dirty_pages, "zone_struct", "inactive_dirty_pages");
			MEMBER_OFFSET_INIT(zone_struct_active_pages, "zone_struct", "active_pages");
			MEMBER_OFFSET_INIT(zone_struct_pages_min, "zone_struct", "pages_min");
			MEMBER_OFFSET_INIT(zone_struct_pages_low, "zone_struct", "pages_low");
			MEMBER_OFFSET_INIT(zone_struct_pages_high, "zone_struct", "pages_high");
			...
			if (INVALID_MEMBER(zone_free_pages)
				...
				if (!enumerator_value("NR_FREE_PAGES", &nr_free_pages))
					error(WARNING, "cannot determine NR_FREE_PAGES enumerator\n");
				ASSIGN_OFFSET(zone_free_pages) = OFFSET(zone_vm_stat) + (nr_free_pages * sizeof(long));
			}
			MEMBER_OFFSET_INIT(zone_free_area, "zone", "free_area");
			MEMBER_OFFSET_INIT(zone_zone_pgdat, "zone", "zone_pgdat");
			MEMBER_OFFSET_INIT(zone_name, "zone", "name");
			MEMBER_OFFSET_INIT(zone_zone_mem_map, "zone", "zone_mem_map");
			MEMBER_OFFSET_INIT(zone_zone_start_pfn, "zone", "zone_start_pfn");
			MEMBER_OFFSET_INIT(zone_spanned_pages, "zone", "spanned_pages");
			MEMBER_OFFSET_INIT(zone_present_pages, "zone", "present_pages");
			MEMBER_OFFSET_INIT(zone_pages_min, "zone", "pages_min");
			MEMBER_OFFSET_INIT(zone_pages_low, "zone", "pages_low");
			MEMBER_OFFSET_INIT(zone_pages_high, "zone", "pages_high");
			MEMBER_OFFSET_INIT(zone_watermark, "zone", "watermark");
			MEMBER_OFFSET_INIT(zone_nr_active, "zone", "nr_active");
			MEMBER_OFFSET_INIT(zone_nr_inactive, "zone", "nr_inactive");
			MEMBER_OFFSET_INIT(zone_all_unreclaimable, "zone", "all_unreclaimable");
			MEMBER_OFFSET_INIT(zone_flags, "zone", "flags");
			MEMBER_OFFSET_INIT(zone_pages_scanned, "zone", "pages_scanned");
			ARRAY_LENGTH_INIT(vt->nr_free_areas, zone_free_area, "zone.free_area", NULL, SIZE(free_area));
	...
	sprintf(buf, "%llx", (ulonglong)
		MAX((uint64_t) vt->max_mapnr * PAGESIZE(), machdep->memory_size()));
	...
	if (symbol_exists("page_hash_bits")) {
		...
		get_symbol_data("page_hash_bits", sizeof(unsigned int), &page_hash_bits);
		len = (1 << page_hash_bits);
		builtin_array_length("page_hash_table", len, NULL);
		get_symbol_data("page_hash_table", sizeof(void *), &vt->page_hash_table);
		vt->page_hash_table_len = len;

		STRUCT_SIZE_INIT(page_cache_bucket, "page_cache_bucket");
		if (VALID_STRUCT(page_cache_bucket))
			MEMBER_OFFSET_INIT(page_cache_bucket_chain, "page_cache_bucket", "chain");
...
void cmd_rd(void)
{
	...
	while ((c = getopt(argcnt, args, "axme:r:pfudDusSNo:81:3:6:")) != EOF) {
		...
		case 'S':
			if (flag & DISPLAY_DEFAULT) {
				...
				error(INFO, "-%c option"
				      ...
				      c, DISPLAY_DEFAULT == DISPLAY_64 ? 64 : 32);
				argerrs++;
			}
			break;
		...
		case 'f':
			if (!pc->dumpfile)
				error(FATAL, "-f option requires a dumpfile\n");
	...
	if (count == -1) {
		if (endaddr) {
			...
			if ((flag & DISPLAY_TYPES) == DISPLAY_RAW)
				error(FATAL, "-r option requires either a count" " argument or the -e option\n");
			count = (flag & DISPLAY_ASCII) ? ASCII_UNLIMITED : 1;
		}
	} else if (endaddr)
		error(WARNING, "ending address ignored when count is specified\n");
...
static void display_memory(ulonglong addr, long count, ulong flag, int memtype, void *opt)
{
	int i, a, j;
	size_t typesz, sz;
	long written;
	...
	if (flag & DISPLAY_RAW) {
		for (written = 0; written < count; written += sz) {
			sz = BUFSIZE > (count - written) ? (size_t) (count - written) : (size_t) BUFSIZE;
			readmem(addr + written, memtype, buf, (long)sz, "raw dump to file", FAULT_ON_ERROR);
	...
	for (i = a = 0; i < count; i++) {
		if (!readmem(addr, memtype, location, typesz, readtype, error_handle)) {
			addr += typesz;
			lost += 1;
			continue;
		}
		...
		if (!(flag & DISPLAY_ASCII) && (((i - lost) % per_line) == 0)) {
			...
			fprintf(fp, "%s:  ", mkstring(buf, VADDR_PRLEN, RJUST | LONGLONG_HEX, MKSTR(&addr)));
			hx = 0;
		...
		case DISPLAY_64:
			if ((flag & (HEXADECIMAL | SYMBOLIC | DISPLAY_DEFAULT))
				...
				if ((flag & SLAB_CACHE) && vaddr_to_kmem_cache(mem.u64, slab, !VERBOSE)) {
					if (CRASHDEBUG(1))
						sprintf(buf, "[%llx:%s]", (ulonglong) mem.u64, slab);
					else
						sprintf(buf, "[%s]", slab);
					fprintf(fp, "%-16s ", buf);
					linelen += strlen(buf) + 1;
			...
			if (flag & HEXADECIMAL) {
				fprintf(fp, hex_64_fmt, LONG_LONG_PRLEN, mem.u64);
		...
		case DISPLAY_32:
			if ((flag & (HEXADECIMAL | SYMBOLIC | DISPLAY_DEFAULT))
				...
				if (in_ksymbol_range(mem.u32)
					...
					fprintf(fp, INT_PRLEN == 16 ? "%-16s " : "%-8s ", buf);
					linelen += strlen(buf) + 1;
					break;
				}
				if ((flag & SLAB_CACHE) && vaddr_to_kmem_cache(mem.u32, slab, !VERBOSE)) {
					if (CRASHDEBUG(1))
						sprintf(buf, "[%x:%s]", mem.u32, slab);
					else
						sprintf(buf, "[%s]", slab);
					fprintf(fp, INT_PRLEN == 16 ? "%-16s " : "%-8s ", buf);
					linelen += strlen(buf) + 1;
			...
			if (isprint(mem.u8)) {
				if ((a % per_line) == 0) {
					if (displayed && i)
						fprintf(fp, "\n");
					fprintf(fp, "%s:  ",
						mkstring(buf, VADDR_PRLEN, RJUST | LONGLONG_HEX, MKSTR(&addr)));
				}
				fprintf(fp, "%c", mem.u8);
				displayed++;
				a++;
...
void cmd_wr(void)
{
	...
	case AMBIGUOUS:
		error(INFO, "ambiguous address: %llx  (requires -p, -u or -k)\n", addr);
		cmd_usage(pc->curcmd, SYNOPSIS);
	}
...
char *format_stack_entry(struct bt_info *bt, char *retbuf, ulong value, ulong limit)
{
	char buf[BUFSIZE];
	char slab[BUFSIZE];
	...
	if (BITS32()) {
		if ((bt->flags & BT_FULL_SYM_SLAB) && accessible(value)) {
			if ((!limit || (value <= limit)) &&
			    in_ksymbol_range(value) && strlen(value_to_symstr(value, buf, 0)))
				sprintf(retbuf, INT_PRLEN == 16 ? "%-16s" : "%-8s", buf);
 ...
 */
int generic_is_kvaddr(ulong addr)
{
 ...
 *        by calling uvtop()?
 */
int generic_is_uvaddr(ulong addr, struct task_context *tc)
{
	return (addr < (ulong) (machdep->kvbase));
}
 ...
 */
void raw_stack_dump(ulong stackbase, ulong size)
{
	display_memory(stackbase, size / sizeof(ulong), HEXADECIMAL | DISPLAY_DEFAULT | SYMBOLIC, KVADDR, NULL);
}

/*
 *  Raw data dump, with the option of symbolic output.
 */
void raw_data_dump(ulong addr, long count, int symbolic)
{
	long wordcnt;
	ulonglong address;
	int memtype;
	...
	display_memory(address, wordcnt,
		       HEXADECIMAL | DISPLAY_DEFAULT | (symbolic ? SYMBOLIC : ASCII_ENDLINE), memtype, NULL);
}

/*
 *  Quietly checks the accessibility of a memory location.
 */
int accessible(ulong kva)
{
	ulong tmp;

	return (readmem(kva, KVADDR, &tmp, sizeof(ulong), "accessible check", RETURN_ON_ERROR | QUIET));
}
...
int readmem(ulonglong addr, int memtype, void *buffer, long size, char *type, ulong error_handle)
{
	int fd;
	long cnt, orig_size;
	physaddr_t paddr;
	...
	while (size > 0) {
		...
		if (CRASHDEBUG(4))
			fprintf(fp, "<%s: addr: %llx paddr: %llx cnt: %ld>\n",
				readmem_function_name(), addr, (unsigned long long)paddr, cnt);
		...
		switch (READMEM(fd, bufptr, cnt, (memtype == PHYSADDR)
				|| (memtype == XENMACHADDR) ? 0 : addr, paddr)) {
		case SEEK_ERROR:
			if (PRINT_ERROR_MESSAGE)
 ...
 readmem_error:
	...
	case (FAULT_ON_ERROR):
		if ((pc->flags & DEVMEM) && (kt->flags & PRE_KERNEL_INIT) &&
			...
			return (readmem(addr, memtype, bufptr, size, type, error_handle));
		/* FALLTHROUGH */
 ...
 *  Accept anything...
 */
int generic_verify_paddr(physaddr_t paddr)
{
	return TRUE;
}
 ...
 *  Read from /dev/mem.
 */
int read_dev_mem(int fd, void *bufptr, int cnt, ulong addr, physaddr_t paddr)
{
	int readcnt;
 ...
 try_dev_kmem:
	 ...
	 */
	if ((readcnt != cnt) && BITS32() && !readcnt && !errno && IS_VMALLOC_ADDR(addr))
 ...
 *  Write to /dev/mem.
 */
int write_dev_mem(int fd, void *bufptr, int cnt, ulong addr, physaddr_t paddr)
{
	if (!machdep->verify_paddr(paddr)) {
		if (CRASHDEBUG(1))
			error(INFO, "verify_paddr(%lx) failed\n", paddr);
...
static int devmem_is_restricted(void)
{
	...
	if (STREQ(pc->live_memsrc, "/dev/mem") && kernel_symbol_exists("devmem_is_allowed")) {
		if (machine_type("X86") || machine_type("X86_64")) {
			if (readmem(255 * PAGESIZE(), PHYSADDR, &tmp,
				    sizeof(long), "devmem_is_allowed - pfn 255",
				    QUIET | RETURN_ON_ERROR) &&
			    !(readmem(257 * PAGESIZE(), PHYSADDR, &tmp,
				      sizeof(long), "devmem_is_allowed - pfn 257", QUIET | RETURN_ON_ERROR)))
				restricted = TRUE;
		}
		if (kernel_symbol_exists("jiffies") &&
		    !readmem(symbol_value("jiffies"), KVADDR, &tmp,
			     sizeof(ulong), "devmem_is_allowed - jiffies", QUIET | RETURN_ON_ERROR))
			restricted = TRUE;
 ...
 */
int read_memory_device(int fd, void *bufptr, int cnt, ulong addr, physaddr_t paddr)
{
 ...
 */
int write_memory_device(int fd, void *bufptr, int cnt, ulong addr, physaddr_t paddr)
{
 ...
 */
int read_mclx_dumpfile(int fd, void *bufptr, int cnt, ulong addr, physaddr_t paddr)
{
 ...
 */
int write_mclx_dumpfile(int fd, void *bufptr, int cnt, ulong addr, physaddr_t paddr)
{
	if (vas_lseek((ulong) paddr, SEEK_SET))
		return SEEK_ERROR;
 ...
 */
int read_lkcd_dumpfile(int fd, void *bufptr, int cnt, ulong addr, physaddr_t paddr)
{
	set_lkcd_fp(fp);
 ...
 */
int write_lkcd_dumpfile(int fd, void *bufptr, int cnt, ulong addr, physaddr_t paddr)
{
 ...
 */
int read_daemon(int fd, void *bufptr, int cnt, ulong vaddr, physaddr_t paddr)
{
	...
	if (BITS32()
	    && remote_memory_read(pc->rkfd, bufptr, cnt, vaddr) == cnt)
		return cnt;
 ...
 */
int write_daemon(int fd, void *bufptr, int cnt, ulong addr, physaddr_t paddr)
{
 ...
 */
static char *memtype_string(int memtype, int debug)
{
 ...
 */
static char *error_handle_string(ulong error_handle)
{
	static char ebuf[20];
	int others;
...
int writemem(ulonglong addr, int memtype, void *buffer, long size, char *type, ulong error_handle)
{
	int fd;
	long cnt;
	physaddr_t paddr;
 ...
 */
static ssize_t read_dev_kmem(ulong vaddr, char *bufptr, long cnt)
{
	ssize_t readcnt;
 ...
 */
static int generic_read_dumpfile(ulonglong addr, void *buffer, long size, char *type, ulong error_handle)
{
	int fd;
	int retval;
	...
	if (lseek(fd, addr, SEEK_SET) == -1) {
		if (PRINT_ERROR_MESSAGE)
			error(INFO, SEEK_ERRMSG, memtype_string(FILEADDR, 0), addr, type);
		retval = FALSE;
	} else if (read(fd, buffer, size) != size) {
		if (PRINT_ERROR_MESSAGE)
			error(INFO, READ_ERRMSG, memtype_string(FILEADDR, 0), addr, type);
		retval = FALSE;
	}
...
static int generic_write_dumpfile(ulonglong addr, void *buffer, long size, char *type, ulong error_handle)
{
	int fd;
	int retval;
	...
	if (lseek(fd, addr, SEEK_SET) == -1) {
		...
		if (PRINT_ERROR_MESSAGE)
			error(INFO, WRITE_ERRMSG, memtype_string(FILEADDR, 0), addr, type);
		retval = FALSE;
	}
...
int kvtop(struct task_context *tc, ulong kvaddr, physaddr_t * paddr, int verbose)
{
	...
	return (machdep->kvtop(tc ? tc : CURRENT_CONTEXT(), kvaddr, paddr ? paddr : &unused, verbose));
}
 ...
 */
int uvtop(struct task_context *tc, ulong vaddr, physaddr_t * paddr, int verbose)
{
	...
	while (args[optind]) {
		...
		if (!(vtop_flags & (UVADDR | KVADDR))) {
			...
			case KVADDR:
				...
				break;
			case AMBIGUOUS:
				error(FATAL, "ambiguous address: %lx  (requires -u or -k)\n", vaddr);
				break;
			}
		} else
			loop_vtop_flags = 0;
 ...
 */
void do_vtop(ulong vaddr, struct task_context *tc, ulong vtop_flags)
{
	physaddr_t paddr;
	ulong vma, page;
	int page_exists;
	...
	case UVADDR:
		fprintf(fp, "%s  %s\n",
			mkstring(buf1, UVADDR_PRLEN, LJUST, "VIRTUAL"), mkstring(buf2, VADDR_PRLEN, LJUST, "PHYSICAL"));

		if (!IN_TASK_VMA(tc->task, vaddr)) {
			fprintf(fp, "%s  (not accessible)\n\n",
				mkstring(buf1, UVADDR_PRLEN, LJUST | LONG_HEX, MKSTR(vaddr)));
			return;
		}
		if (!uvtop(tc, vaddr, &paddr, 0)) {
			fprintf(fp, "%s  %s\n\n",
				mkstring(buf1, UVADDR_PRLEN, LJUST | LONG_HEX,
					 MKSTR(vaddr)),
				(XEN() && (paddr == PADDR_NOT_AVAILABLE)) ? "(page not available)" : "(not mapped)");
			...
			fprintf(fp, "%s  %s\n\n",
				mkstring(buf1, UVADDR_PRLEN, LJUST | LONG_HEX,
					 MKSTR(vaddr)),
				mkstring(buf2, VADDR_PRLEN, LJUST | LONGLONG_HEX, MKSTR(&paddr)));
			page_exists = TRUE;
		}
	...
	case KVADDR:
		fprintf(fp, "%s  %s\n",
			mkstring(buf1, VADDR_PRLEN, LJUST, "VIRTUAL"), mkstring(buf2, VADDR_PRLEN, LJUST, "PHYSICAL"));
		...
		if (vtop_flags & USE_USER_PGD) {
			if (!uvtop(tc, vaddr, &paddr, 0)) {
				fprintf(fp, "%s  %s\n\n",
					mkstring(buf1, UVADDR_PRLEN, LJUST | LONG_HEX, MKSTR(vaddr)), (XEN()
												       && (paddr ==
													   PADDR_NOT_AVAILABLE))
			...
			if (!kvtop(tc, vaddr, &paddr, 0)) {
				fprintf(fp, "%s  %s\n\n",
					mkstring(buf1, VADDR_PRLEN, LJUST | LONG_HEX, MKSTR(vaddr)), (XEN()
												      && (paddr ==
													  PADDR_NOT_AVAILABLE))
					? "(page not available)" : "(not mapped)");
				page_exists = FALSE;
...
void cmd_ptov(void)
{
	...
	while (args[optind]) {
		...
		unknown = BITS32() && (!kvtop(0, vaddr, &paddr_test, 0) || (paddr_test != paddr));
		...
		fprintf(fp, "%s  %s\n", unknown ?
			...
			mkstring(buf1, VADDR_PRLEN, LJUST | LONG_HEX,
				 MKSTR(vaddr)), mkstring(buf2, VADDR_PRLEN, LJUST | LONGLONG_HEX, MKSTR(&paddr)));
...
static void do_vm_flags(ulonglong flags)
{
	int others;
	...
	if (symbol_exists("nr_bigpages")
	    && (THIS_KERNEL_VERSION == LINUX(2, 4, 9))) {
		if (flags & VM_BIGPAGE)
			fprintf(fp, "%sBIGPAGE", others++ ? "|" : "");
		if (flags & VM_BIGMAP)
			fprintf(fp, "%sBIGMAP", others++ ? "|" : "");
	} else {
		if ((THIS_KERNEL_VERSION < LINUX(2, 4, 21)) && (flags & VM_WRITECOMBINED))
 ...
 */
static ulonglong get_vm_flags(char *vma_buf)
{
...
ulong vm_area_dump(ulong task, ulong flag, ulong vaddr, struct reference * ref)
{
	...
	if (ref) {
		...
		if (IS_A_NUMBER(ref->str)) {
			...
			if (decimal(ref->str, 0))
				ref->decval = dtol(ref->str, FAULT_ON_ERROR, NULL);
			ref->cmdflags |= VM_REF_NUMBER;
		}
	}

	if (VM_REF_CHECK_HEXVAL(ref, tm->mm_struct_addr) || VM_REF_CHECK_HEXVAL(ref, tm->pgd_addr)) {
	...
	sprintf(vma_header, "%s%s%s%s%s  FLAGS%sFILE\n",
		...
		space(MINSPACE), mkstring(buf3, UVADDR_PRLEN, CENTER | RJUST, "END"), space(MINSPACE));
	...
	for (found = FALSE; vma; vma = vm_next) {
		...
		if (vm_file && !(flag & VERIFY_ADDR)) {
			...
			if (dentry) {
				...
				if (VALID_MEMBER(file_f_vfsmnt)) {
					...
					get_pathname(dentry, buf1, BUFSIZE, 1, vfsmnt);
				} else {
					get_pathname(dentry, buf1, BUFSIZE, 1, 0);
				}
			}
		...
		if (!(flag & UVADDR) || ((flag & UVADDR) && ((vaddr >= vm_start)
							     && (vaddr < vm_end)))) {
			found = TRUE;
			...
			if (DO_REF_SEARCH(ref)) {
				if (VM_REF_CHECK_HEXVAL(ref, vma) || VM_REF_CHECK_HEXVAL(ref, (ulong) vm_flags)
				...
				if (vm_area_page_dump(vma, task, vm_start, vm_end, vm_mm, ref)) {
					if (!(ref->cmdflags & VM_REF_HEADER)) {
						print_task_header(fp, tc, 0);
						PRINT_VM_DATA();
						ref->cmdflags |= VM_REF_HEADER;
					...
					vm_area_page_dump(vma, task, vm_start, vm_end, vm_mm, ref);
					ref->cmdflags &= ~VM_REF_DISPLAY;
				}
			...
			if (inode) {
				fprintf(fp, "%lx%s%s%s%s%s%6llx%s%lx %s\n",
					...
					space(MINSPACE), mkstring(buf3,
								  ...
								  MKSTR
								  (vm_end)),
					space(MINSPACE), vm_flags, space(MINSPACE), inode, buf1);
			} else {
				PRINT_VMA_DATA();
...
static int vm_area_page_dump(ulong vma, ulong task, ulong start, ulong end, ulong mm, struct reference *ref)
{
	physaddr_t paddr;
	ulong offs;
	char *p1, *p2;
	...
	if (!ref || DO_REF_DISPLAY(ref))
		fprintf(fp, "%s  %s\n",
			...
			mkstring(buf2, MAX(PADDR_PRLEN, strlen("PHYSICAL")), LJUST, "PHYSICAL"));
		...
		if (uvtop(task_to_context(task), start, &paddr, 0)) {
			sprintf(buf3, "%s  %s\n",
				...
				mkstring(buf2, MAX(PADDR_PRLEN,
						   strlen("PHYSICAL")), RJUST | LONGLONG_HEX, MKSTR(&paddr)));
			...
			sprintf(buf3, "%s  SWAP: %s\n",
				mkstring(buf2, UVADDR_PRLEN, LJUST | LONG_HEX, MKSTR(start)), buf1);

			if (DO_REF_SEARCH(ref)) {
				if (VM_REF_CHECK_DECVAL(ref,
							THIS_KERNEL_VERSION >=
							LINUX(2, 6, 0) ? __swp_offset(paddr) : SWP_OFFSET(paddr))) {
					if (DO_REF_DISPLAY(ref))
						display = TRUE;
					else {
						ref->cmdflags |= VM_REF_PAGE;
			...
			if (DO_REF_SEARCH(ref)) {
				extract_hex(strstr(buf3, "OFFSET:") + strlen("OFFSET: "), &offs, 0, 0);
			...
			sprintf(buf3, "%s  (not mapped)\n",
				mkstring(buf1, UVADDR_PRLEN, LJUST | LONG_HEX, MKSTR(start)));
		}
...
char *fill_vma_cache(ulong vma)
{
	...
	readmem(vma, KVADDR, cache, SIZE(vm_area_struct), "fill_vma_cache", FAULT_ON_ERROR);
 ...
 */
int in_user_stack(ulong task, ulong vaddr)
{
	ulong vma;
	ulonglong vm_flags;
	char *vma_buf;
	...
	if ((vma = vm_area_dump(task, UVADDR | VERIFY_ADDR, vaddr, 0))) {
		...
		if (vm_flags & VM_GROWSDOWN)
			return TRUE;
		else if (kernel_symbol_exists("expand_upwards") && (vm_flags & VM_GROWSUP))
			return TRUE;
		/*
		 *  per-thread stack
		 */
 ...
 */
void get_task_mem_usage(ulong task, struct task_mem_usage *tm)
{
	struct task_context *tc;
	...
	if (VALID_MEMBER(mm_struct_rss))
		...
		if (VALID_MEMBER(mm_struct_rss_stat)) {
			...
			tm->rss += ULONG(tt->mm_struct +
					 ...
					 OFFSET(mm_rss_stat_count) + (filepages * sizeof(ulong)));
			tm->rss += ULONG(tt->mm_struct +
					 OFFSET(mm_struct_rss_stat) +
					 OFFSET(mm_rss_stat_count) + (anonpages * sizeof(ulong)));
		}
		/*
	...
	tm->pct_physmem = ((double)(tm->rss * 100)) /
	    ((double)(MIN(vt->total_pages, vt->num_physpages ? vt->num_physpages : vt->total_pages)));
}
...
void cmd_kmem(void)
{
	...
	while (args[optind]) {
		if (hexadecimal(args[optind], 0)) {
			value[spec_addr++] = htoll(args[optind], FAULT_ON_ERROR, NULL);
		} else {
			if (meminfo.reqname)
				error(FATAL, "only one kmem_cache reference is allowed\n");
	...
	for (i = 0; i < spec_addr; i++) {
		...
		if (sflag || Sflag) {
			if (vt->flags & KMEM_CACHE_UNAVAIL)
				error(FATAL, "kmem cache slab subsystem not available\n");
			...
			if (meminfo.memtype == PHYSADDR) {
				if (value[i] < VTOP(vt->high_memory)) {
					...
					error(WARNING, "cannot make virtual-to-physical translation: %llx\n", value[i]);
			}
		 ...
		 */
		if (zflag || nflag || iflag || Fflag || Cflag || Lflag || Vflag || oflag) {
			error(INFO, "no address arguments allowed with this option\n");
			cmd_usage(pc->curcmd, SYNOPSIS);
		}

		if (!(sflag + Sflag + pflag + fflag + vflag + cflag + lflag + Lflag + gflag)) {
			meminfo.spec_addr = value[i];
			meminfo.flags = ADDRESS_SPECIFIED;
			if (meminfo.calls++)
				fprintf(fp, "\n");
	...
	if (!(sflag + Sflag + pflag + fflag + Fflag + vflag +
	      Vflag + zflag + oflag + cflag + Cflag + iflag + nflag + lflag + Lflag + gflag + meminfo.calls))
		cmd_usage(pc->curcmd, SYNOPSIS);
...
static void PG_reserved_flag_init(void)
{
	...
	if (!readmem(pageptr, KVADDR, buf, SIZE(page), "reserved page", RETURN_ON_ERROR | QUIET)) {
		FREEBUF(buf);
		return;
	}
...
#define PG_reclaim              17	/* To be reclaimed asap */
	...
	if (try_get_symbol_data("vm_area_cachep", sizeof(void *), &vaddr) &&
	    ...
	    readmem(pageptr, KVADDR, buf, SIZE(page), "vm_area_cachep page", RETURN_ON_ERROR | QUIET)) {
...
static void dump_mem_map_SPARSEMEM(struct meminfo *mi)
{
	ulong i;
	long total_pages;
	...
	sprintf((char *)&style1, "%%lx%s%%%dllx%s%%%dlx%s%%8lx %%2d%s",
		...
		space(MINSPACE), VADDR_PRLEN, space(MINSPACE), space(MINSPACE));
	sprintf((char *)&style2, "%%-%dlx%s%%%dllx%s%s%s%s %2s ", VADDR_PRLEN,
		space(MINSPACE), (int)MAX(PADDR_PRLEN, strlen("PHYSICAL")),
		space(MINSPACE), mkstring(buf3, VADDR_PRLEN, CENTER | RJUST,
					  " "), space(MINSPACE), mkstring(buf4, 8, CENTER | RJUST, " "), " ");
	sprintf((char *)&style3, "%%-%dlx%s%%%dllx%s%s%s%s %%2d ",
		VADDR_PRLEN, space(MINSPACE), (int)MAX(PADDR_PRLEN,
						       strlen("PHYSICAL")),
		space(MINSPACE), mkstring(buf3, VADDR_PRLEN, CENTER | RJUST,
					  "-------"), space(MINSPACE), mkstring(buf4, 8, CENTER | RJUST, "-----"));
	sprintf((char *)&style4, "%%-%dlx%s%%%dllx%s%%%dlx%s%%8lx %%2d ",
		VADDR_PRLEN, space(MINSPACE), (int)MAX(PADDR_PRLEN,
						       strlen("PHYSICAL")),
		space(MINSPACE), VADDR_PRLEN, space(MINSPACE));
	...
	if (v22) {
		sprintf(hdr, "%s%s%s%s%s%s%s%sCNT FLAGS\n",
			...
			space(MINSPACE), mkstring(buf4, 8, CENTER | LJUST, "OFFSET"), space(MINSPACE - 1));
	} else {
		sprintf(hdr, "%s%s%s%s%s%s%sCNT FLAGS\n",
			...
			space(MINSPACE), mkstring(buf4, 8, CENTER | RJUST, "INDEX"));
	}
	...
	for (section_nr = 0; section_nr < nr_mem_sections; section_nr++) {
		...
		for (i = 0; i < section_size; i++, pp += SIZE(page), phys += PAGESIZE()) {
			...
			if ((i % PGMM_CACHED) == 0) {
				...
				if ((pg_spec && (mi->spec_addr > ppend)) ||
				    (phys_spec && (PHYSPAGEBASE(mi->spec_addr) > physend))) {
					i += (PGMM_CACHED - 1);
					pp = ppend;
					phys = physend;
					continue;
			...
			if ((pg_spec && (pp == mi->spec_addr)) || (phys_spec && (phys == PHYSPAGEBASE(mi->spec_addr))))
				done = TRUE;
			...
			case GET_BUFFERS_PAGES:
				if (VALID_MEMBER(page_buffers)) {
					...
					error(FATAL, "cannot determine whether pages have buffers\n");
			...
			case GET_TOTALRAM_PAGES:
				if (vt->PG_reserved)
					...
					PG_reserved_flag = v22 ? 1 << v22_PG_reserved : 1 << v24_PG_reserved;

				if (flags & PG_reserved_flag) {
					reserved++;
				} else {
					if ((int)count > (vt->flags & PGCNT_ADJ ? 0 : 1))
						shared++;
				}
				continue;
			}
			...
			if (v22) {
				...
				mapping = ULONG(pcache + OFFSET(page_mapping));
			...
			if (v22) {
				bufferindex +=
				    sprintf(outputbuffer + bufferindex,
					    (char *)&style1, pp, phys, inode, offset, count);
			} else {
				...
				if (page_not_mapped)
					bufferindex += sprintf(outputbuffer + bufferindex, (char *)&style2, pp, phys);
				else if (!page_mapping)
					bufferindex +=
					    sprintf(outputbuffer + bufferindex, (char *)&style3, pp, phys, count);
				else
					bufferindex +=
					    sprintf(outputbuffer + bufferindex,
						    (char *)&style4, pp, phys, mapping, index, count);
			}
...
static void dump_mem_map(struct meminfo *mi)
{
	long i, n;
	long total_pages;
	int others, page_not_mapped, phys_not_mapped, page_mapping;
	...
	for (n = 0; n < vt->numnodes; n++) {
		...
		for (i = 0; i < node_size; i++, pp += SIZE(page), phys += PAGESIZE()) {
 ...
 */
static void fill_mem_map_cache(ulong pp, ulong ppend, char *page_cache)
{
	long size, cnt;
	ulong addr;
	char *bufptr;
	 ...
	 */
	if (readmem(pp, KVADDR, page_cache, SIZE(page) * PGMM_CACHED, "page struct cache", RETURN_ON_ERROR | QUIET))
		return;
	...
	while (size > 0) {
		...
		if (!readmem(addr, KVADDR, bufptr, size, "virtual page struct cache", RETURN_ON_ERROR | QUIET)) {
			BZERO(bufptr, size);
...
static void dump_page_hash_table(struct meminfo *hi)
{
	int i;
	int len, entry_len;
	...
	entry_len = VALID_STRUCT(page_cache_bucket) ? SIZE(page_cache_bucket) : sizeof(void *);
	...
	if (req.length == sizeof(int)) {
		...
		get_symbol_data("page_cache_size", sizeof(long), &page_cache_size);
	...
	hq_open();
	for (i = total_cached = 0; i < len; i++, page_hash_table += entry_len) {

		if ((i % PGHASH_CACHED) == 0) {
			readmem(page_hash_table, KVADDR, pghash_cache,
				entry_len * PGHASH_CACHED, "page hash cache", FAULT_ON_ERROR);
		}
	...
	if (searchpage) {
		...
		while (fgets(buf, BUFSIZE, pc->tmpfile)) {
			...
			this_addr = htol(strip_linefeeds(buf), RETURN_ON_ERROR, &errflag);
...
static void dump_free_pages(struct meminfo *fi)
{
	int i;
	int order;
	ulong free_area;
	...
	if (dimension)
		error(FATAL, "dump_free_pages called with multidimensional free area\n");
	...
	readmem(free_area, KVADDR, free_area_buf,
		SIZE(free_area_struct) * nr_mem_lists, "free_area_struct", FAULT_ON_ERROR);
	...
	while (fgets(buf, BUFSIZE, pc->tmpfile)) {
		...
		if (strstr(buf, "nr_free_pages") || STREQ(buf, "\n"))
			continue;
	...
	if (found) {
		...
		if (order) {
			...
			case KVADDR:
				...
				break;
			case PHYSADDR:
				fprintf(fp, "(%llx is %s", fi->spec_addr, PAGEOFFSET(fi->spec_addr) ? "in " : "");
				break;
			}
			fprintf(fp, "%s of %ld pages) ", ordinal(offset + 1, buf), power(2, order));
		}
 ...
 */
char *free_area_hdr5 = "  AREA    SIZE  FREE_AREA_STRUCT  BLOCKS   PAGES\n";
char *free_area_hdr6 = "  AREA    SIZE  FREE_AREA_STRUCT\n";

static void dump_multidimensional_free_pages(struct meminfo *fi)
{
	int i, j;
	struct list_data list_data, *ld;
	long cnt, total_free;
	...
	if (vt->flags & (NODES | ZONES))
		error(FATAL, "dump_multidimensional_free_pages called with (NODES|ZONES)\n");
	...
	case ADDRESS_SPECIFIED:
		...
		case PHYSADDR:
			...
			break;
		default:
			error(FATAL, "dump_multidimensional_free_pages: no memtype specified\n");
		}
		do_search = TRUE;
		break;
	}
	...
	free_area_buf = GETBUF((nr_mem_lists * SIZE(free_area_struct)) * dimension);
	kfp = free_area = symbol_value("free_area");
	readmem(free_area, KVADDR, free_area_buf,
		(SIZE(free_area_struct) * nr_mem_lists) * dimension, "free_area arrays", FAULT_ON_ERROR);
	...
	for (i = sum = found = 0; i < dimension; i++) {
		...
		pp = (ulong *) (free_area_buf + ((SIZE(free_area_struct) * nr_mem_lists) * i));
...
static void dump_free_pages_zones_v1(struct meminfo *fi)
{
	int i, n;
	ulong node_zones;
	ulong size;
	...
	if (!(vt->flags & (NODES | ZONES)))
		error(FATAL, "dump_free_pages_zones_v1 called without (NODES|ZONES)\n");
	...
	if (fi->flags & ADDRESS_SPECIFIED) {
		...
		case PHYSADDR:
			...
			break;
		default:
			error(FATAL, "dump_free_pages_zones_v1: no memtype specified\n");
		}
		do_search = TRUE;
	} else {
		searchphys = 0;
	...
	if (VALID_MEMBER(zone_struct_size))
		...
		error(FATAL, "zone_struct has neither size nor memsize field\n");
		...
		for (i = 0; i < vt->nr_zones; i++) {
			...
			if (fi->flags == GET_FREE_PAGES) {
				readmem(node_zones +
					...
					KVADDR, &value, sizeof(ulong), "node_zones free_pages", FAULT_ON_ERROR);
				sum += value;
			...
			if (fi->flags == GET_ZONE_SIZES) {
				readmem(node_zones + zone_size_offset,
					KVADDR, &size, sizeof(ulong), "node_zones {mem}size", FAULT_ON_ERROR);
				sum += size;
				node_zones += SIZE(zone_struct);
				continue;
			}
			...
			if ((i == 0) && (vt->flags & NODES)) {
				if (n) {
					fprintf(fp, "\n");
					pad_line(fp, VADDR_PRLEN > 8 ? 74 : 66, '-');
					fprintf(fp, "\n");
				}
				fprintf(fp, "%sNODE\n %2d\n", n ? "\n" : "", nt->node_id);
			}
			...
			fprintf(fp, "%s%s  %s  START_PADDR  START_MAPNR\n",
				i > 0 ? "\n" : "", zone_hdr, mkstring(buf1, VADDR_PRLEN, CENTER | LJUST, "MEM_MAP"));

			fprintf(fp, "%3d   ", i);

			readmem(node_zones + OFFSET(zone_struct_name), KVADDR,
				&value, sizeof(void *), "node_zones name", FAULT_ON_ERROR);
			...
			readmem(node_zones + zone_size_offset, KVADDR,
				&size, sizeof(ulong), "node_zones {mem}size", FAULT_ON_ERROR);
			fprintf(fp, "%6ld  ", size);
			...
			readmem(node_zones +
				OFFSET(zone_struct_zone_start_paddr), KVADDR,
				&zone_start_paddr, sizeof(ulong), "node_zones zone_start_paddr", FAULT_ON_ERROR);
			readmem(node_zones +
				OFFSET(zone_struct_zone_start_mapnr), KVADDR,
				&zone_start_mapnr, sizeof(ulong), "node_zones zone_start_mapnr", FAULT_ON_ERROR);
			readmem(node_zones + OFFSET(zone_struct_zone_mem_map),
				KVADDR, &zone_mem_map, sizeof(ulong), "node_zones zone_mem_map", FAULT_ON_ERROR);

			fprintf(fp, "%s  %s  %s\n",
				mkstring(buf1, VADDR_PRLEN,
					 CENTER | LONG_HEX,
					 MKSTR(zone_mem_map)), mkstring(buf2,
									strlen
									("START_PADDR"),
									CENTER |
									LONG_HEX
				...
				mkstring(buf3, strlen("START_MAPNR"),
					 CENTER | LONG_DEC | RJUST, MKSTR(zone_start_mapnr)));

			sum += value;

			if (value)
				found += dump_zone_free_area(node_zones +
							     OFFSET(zone_struct_free_area), vt->nr_free_areas, verbose);
	...
	while (fgets(buf, BUFSIZE, pc->tmpfile)) {
		...
		if (CRASHDEBUG(0) && !hexadecimal(strip_linefeeds(buf), 0))
			continue;
 ...
 */
static void dump_free_pages_zones_v2(struct meminfo *fi)
{
	int i, n;
	ulong node_zones;
	ulong size;
	...
	if (!(vt->flags & (NODES | ZONES)))
		error(FATAL, "dump_free_pages_zones_v2 called without (NODES|ZONES)\n");
	...
	if (fi->flags & ADDRESS_SPECIFIED) {
		...
		case PHYSADDR:
			...
			break;
		default:
			error(FATAL, "dump_free_pages_zones_v2: no memtype specified\n");
		}
		do_search = TRUE;
	} else {
		searchphys = 0;
	...
	for (n = sum = found = 0; n < vt->numnodes; n++) {
		...
		for (i = 0; i < vt->nr_zones; i++) {
			...
			if (fi->flags == GET_ZONE_SIZES) {
				readmem(node_zones + zone_size_offset,
					KVADDR, &size, sizeof(ulong), "node_zones size", FAULT_ON_ERROR);
				sum += size;
				node_zones += SIZE(zone);
				continue;
			}
			...
			readmem(node_zones + zone_size_offset, KVADDR,
				&size, sizeof(ulong), "node_zones size", FAULT_ON_ERROR);
			fprintf(fp, "%6ld  ", size);
			...
			readmem(node_zones + OFFSET(zone_zone_start_pfn),
				KVADDR, &zone_start_pfn, sizeof(ulong), "node_zones zone_start_pfn", FAULT_ON_ERROR);
			...
			if (!VALID_MEMBER(zone_zone_mem_map)) {
				if (IS_SPARSEMEM() || IS_DISCONTIGMEM()) {
					...
					zone_mem_map = 0;
					if (size)
						zone_mem_map = nt->mem_map + (zone_start_pfn * SIZE(page));
				} else
					error(FATAL, "\ncannot determine zone mem_map: TBD\n");
			}

			if (zone_mem_map)
				zone_start_mapnr = (zone_mem_map - nt->mem_map) / SIZE(page);
			else
				zone_start_mapnr = 0;
			...
			if (value)
				found += dump_zone_free_area(node_zones +
							     OFFSET(zone_free_area), vt->nr_free_areas, verbose);
	...
	if (found) {
		...
		if (order) {
			...
			fprintf(fp, "%s of %ld pages)", ordinal(offset + 1, buf), chunk_size / PAGESIZE());
		}
...
static char *page_usage_hdr = "ZONE  NAME        FREE   ACTIVE  INACTIVE_DIRTY  INACTIVE_CLEAN  MIN/LOW/HIGH";
...
static int dump_zone_page_usage(void)
{
	...
	if (!VALID_MEMBER(zone_struct_inactive_dirty_pages) ||
	    ...
	    !VALID_MEMBER(zone_struct_pages_low) || !VALID_MEMBER(zone_struct_pages_high))
		return FALSE;
	...
	for (n = 0; n < vt->numnodes; n++) {
		...
		for (i = 0; i < vt->nr_zones; i++) {
			readmem(node_zones + OFFSET(zone_struct_free_pages),
				KVADDR, &free_pages, sizeof(ulong), "node_zones free_pages", FAULT_ON_ERROR);
			readmem(node_zones +
				OFFSET(zone_struct_inactive_dirty_pages),
				KVADDR, &inactive_dirty_pages, sizeof(ulong),
				"node_zones inactive_dirty_pages", FAULT_ON_ERROR);
			readmem(node_zones +
				OFFSET(zone_struct_inactive_clean_pages),
				KVADDR, &inactive_clean_pages, sizeof(ulong),
				"node_zones inactive_clean_pages", FAULT_ON_ERROR);
			readmem(node_zones + OFFSET(zone_struct_active_pages),
				KVADDR, &active_pages, sizeof(ulong), "node_zones active_pages", FAULT_ON_ERROR);
			readmem(node_zones + OFFSET(zone_struct_pages_min),
				KVADDR, &pages_min, sizeof(ulong), "node_zones pages_min", FAULT_ON_ERROR);
			readmem(node_zones + OFFSET(zone_struct_pages_low),
				KVADDR, &pages_low, sizeof(ulong), "node_zones pages_low", FAULT_ON_ERROR);
			readmem(node_zones + OFFSET(zone_struct_pages_high),
				KVADDR, &pages_high, sizeof(ulong), "node_zones pages_high", FAULT_ON_ERROR);
			...
			sprintf(buf2, "%ld/%ld/%ld", pages_min, pages_low, pages_high);
			fprintf(fp, "%3d   %s %7ld  %7ld %15ld %15ld  %s\n", i,
				namebuf, free_pages, active_pages,
				inactive_dirty_pages, inactive_clean_pages,
				mkstring(buf3, strlen("MIN/LOW/HIGH"), CENTER, buf2));
...
static int dump_zone_free_area(ulong free_area, int num, ulong verbose)
{
	int i, j;
	long chunk_size;
	...
	if (VALID_STRUCT(free_area_struct)) {
		if (SIZE(free_area_struct) != (3 * sizeof(ulong)))
			error(FATAL, "unrecognized free_area_struct size: %ld\n", SIZE(free_area_struct));
		list_count = 1;
		...
		if (SIZE(free_area) == (3 * sizeof(ulong)))
			...
			readmem(free_area, KVADDR, free_area_buf2, SIZE(free_area), "free_area struct", FAULT_ON_ERROR);
		}
	} else
		error(FATAL, "neither free_area_struct or free_area structures exist\n");
	...
	for (i = 0; i < num; i++, free_area += SIZE_OPTION(free_area_struct, free_area)) {
		if (verbose)
		...
		readmem(free_area, KVADDR, free_area_buf, sizeof(ulong) * 3, "free_area_struct", FAULT_ON_ERROR);

		fprintf(fp, "%s  ", mkstring(buf, flen, CENTER | LONG_HEX, MKSTR(free_area)));
		...
		if (VALID_MEMBER(page_list_next))
			...
			ld->list_head_offset = OFFSET(page_lru) + OFFSET(list_head_next);
		else
			error(FATAL, "neither page.list or page.lru exist?\n");
 ...
 multiple_lists:
	...
	for (i = 0; i < num; i++, free_area += SIZE_OPTION(free_area_struct, free_area)) {
		...
		for (j = 0, free_list = free_area; j < list_count; j++, free_list += SIZE(list_head)) {
			...
			readmem(free_list, KVADDR, free_list_buf,
				SIZE(list_head), "free_area free_list", FAULT_ON_ERROR);
			fprintf(fp, "%s  ", mkstring(buf, flen, CENTER | LONG_HEX, MKSTR(free_list)));
			...
			cnt = do_list(ld);
			if (cnt < 0) {
				error(pc->curcmd_flags & IGNORE_ERRORS ? INFO :
				      FATAL, "corrupted free list %d from free_area struct: %lx\n", j, free_area);
				if (pc->curcmd_flags & IGNORE_ERRORS)
					goto bailout;
			}
...
static void dump_kmeminfo(void)
{
	...
	if (symbol_exists("totalram_pages")) {
		totalram_pages = vt->totalram_pages ? vt->totalram_pages : get_totalram;
	} else
		totalram_pages = get_totalram;

	fprintf(fp, "%10s  %7ld  %11s         ----\n", "TOTAL MEM", totalram_pages, pages_to_size(totalram_pages, buf));
	...
	if (symbol_exists("page_cache_size")) {
		...
		if (symbol_exists("swapper_spaces") && (len = get_array_length("swapper_spaces", NULL, 0))) {
			for (i = 0; i < len; i++) {
				if (!readmem(symbol_value("swapper_spaces") +
					     i * SIZE(address_space), KVADDR,
					     swapper_space, SIZE(address_space), "swapper_space", RETURN_ON_ERROR))
					break;
				swapper_space_nrpages += ULONG(swapper_space + OFFSET(address_space_nrpages));
			}
	...
	fprintf(fp, "%10s  %7ld  %11s  %3ld%% of TOTAL MEM\n",
		"CACHED", page_cache_size, pages_to_size(page_cache_size, buf), pct);
	...
	if (symbol_exists("totalhigh_pages")) {
		switch (get_syment_array("totalhigh_pages", sp_array, 2)) {
		case 1:
			get_symbol_data("totalhigh_pages", sizeof(ulong), &totalhigh_pages);
			break;
		case 2:
			if (!(readmem(sp_array[0]->value, KVADDR,
				      &value1, sizeof(ulong), "totalhigh_pages #1", RETURN_ON_ERROR)))
		...
		pct = totalhigh_pages ? (totalhigh_pages * 100) / totalram_pages : 0;
		fprintf(fp, "\n%10s  %7ld  %11s  %3ld%% of TOTAL MEM\n",
			"TOTAL HIGH", totalhigh_pages, pages_to_size(totalhigh_pages, buf), pct);

		meminfo.flags = GET_FREE_HIGHMEM_PAGES;
		vt->dump_free_pages(&meminfo);
		freehighmem_pages = meminfo.retval;
		pct = freehighmem_pages ? (freehighmem_pages * 100) / totalhigh_pages : 0;
		fprintf(fp, "%10s  %7ld  %11s  %3ld%% of TOTAL HIGH\n",
			"FREE HIGH", freehighmem_pages, pages_to_size(freehighmem_pages, buf), pct);

		totallowmem_pages = totalram_pages - totalhigh_pages;
		pct = (totallowmem_pages * 100) / totalram_pages;
		fprintf(fp, "%10s  %7ld  %11s  %3ld%% of TOTAL MEM\n",
			"TOTAL LOW", totallowmem_pages, pages_to_size(totallowmem_pages, buf), pct);
		...
		fprintf(fp, "%10s  %7ld  %11s  %3ld%% of TOTAL LOW\n",
			"FREE LOW", freelowmem_pages, pages_to_size(freelowmem_pages, buf), pct);
	}
	...
	if (symbol_exists("swapper_space") || symbol_exists("swapper_spaces")) {
		if (dump_swap_info(RETURN_ON_ERROR, &totalswap_pages, &totalused_pages)) {
			fprintf(fp, "%10s  %7ld  %11s         ----\n",
				"TOTAL SWAP", totalswap_pages, pages_to_size(totalswap_pages, buf));
			pct = totalswap_pages ? (totalused_pages * 100) / totalswap_pages : 100;
			fprintf(fp, "%10s  %7ld  %11s  %3ld%% of TOTAL SWAP\n",
				"SWAP USED", totalused_pages, pages_to_size(totalused_pages, buf), pct);
			pct = totalswap_pages ? ((totalswap_pages - totalused_pages) * 100) / totalswap_pages : 0;
			fprintf(fp, "%10s  %7ld  %11s  %3ld%% of TOTAL SWAP\n",
				"SWAP FREE", totalswap_pages - totalused_pages,
				pages_to_size(totalswap_pages - totalused_pages, buf), pct);
		} else
			error(INFO,
...
static ulong nr_blockdev_pages(void)
{
	...
	for (i = nrpages = 0; i < bdevcnt; i++) {
		...
		readmem(inode, KVADDR, inode_buf, SIZE(inode), "inode buffer", FAULT_ON_ERROR);
		address_space = ULONG(inode_buf + OFFSET(inode_i_mapping));
		readmem(address_space, KVADDR, address_space_buf,
			SIZE(address_space), "address_space buffer", FAULT_ON_ERROR);
...
static void dump_vmlist(struct meminfo *vi)
{
	char buf[BUFSIZE];
	char buf1[BUFSIZE];
	char buf2[BUFSIZE];
	...
	while (next) {
		if (!(pc->curcmd_flags & HEADER_PRINTED) && (next == vmlist) &&
			...
			fprintf(fp, "%s  ",
				mkstring(buf, MAX(strlen("VM_STRUCT"), VADDR_PRLEN), CENTER | LJUST, "VM_STRUCT"));
			fprintf(fp, "%s    SIZE\n",
				mkstring(buf, (VADDR_PRLEN * 2) + strlen(" - "), CENTER | LJUST, "ADDRESS RANGE"));
			pc->curcmd_flags |= HEADER_PRINTED;
		}

		readmem(next + OFFSET(vm_struct_addr), KVADDR, &addr, sizeof(void *), "vmlist addr", FAULT_ON_ERROR);
		readmem(next + OFFSET(vm_struct_size), KVADDR, &size, sizeof(ulong), "vmlist size", FAULT_ON_ERROR);
		...
		if (!(vi->flags & ADDRESS_SPECIFIED) || ((vi->memtype == KVADDR) && ((vi->spec_addr >= addr)
										     && (vi->spec_addr <
											 (addr + size))))) {
			...
			fprintf(fp, "%s%s  %s - %s  %6ld\n",
				...
				mkstring(buf1, VADDR_PRLEN, LONG_HEX | RJUST,
					 MKSTR(addr)), mkstring(buf2,
								VADDR_PRLEN,
								LONG_HEX | LJUST, MKSTR(addr + size)), size);
		}

		if ((vi->flags & ADDRESS_SPECIFIED)
		    && (vi->memtype == PHYSADDR)) {
			for (pcheck = addr; pcheck < (addr + size); pcheck += PAGESIZE()) {
				if (!kvtop(NULL, pcheck, &paddr, 0))
					continue;
				if ((vi->spec_addr >= paddr) && (vi->spec_addr < (paddr + PAGESIZE()))) {
					if (vi->flags & GET_PHYS_TO_VMALLOC) {
						vi->retval = pcheck + PAGEOFFSET(paddr);
						return;
					} else
						fprintf(fp,
							"%s%s  %s - %s  %6ld\n",
 ...
 next_entry:
		readmem(next + OFFSET(vm_struct_next), KVADDR, &next, sizeof(void *), "vmlist next", FAULT_ON_ERROR);
...
static void dump_vmap_area(struct meminfo *vi)
{
	int i, cnt;
	...
	for (i = 0; i < cnt; i++) {
		if (!(pc->curcmd_flags & HEADER_PRINTED) && (i == 0) &&
		    !(vi->flags & (GET_HIGHEST | GET_PHYS_TO_VMALLOC |
				   GET_VMLIST_COUNT | GET_VMLIST | VMLIST_VERIFY))) {
			fprintf(fp, "%s  ",
				mkstring(buf1, MAX(strlen("VMAP_AREA"), VADDR_PRLEN), CENTER | LJUST, "VMAP_AREA"));
			fprintf(fp, "%s  ",
				mkstring(buf1, MAX(strlen("VM_STRUCT"), VADDR_PRLEN), CENTER | LJUST, "VM_STRUCT"));
			fprintf(fp, "%s     SIZE\n",
				mkstring(buf1, (VADDR_PRLEN * 2) + strlen(" - "), CENTER | LJUST, "ADDRESS RANGE"));
			pc->curcmd_flags |= HEADER_PRINTED;
		}

		readmem(vmap_area_list[i], KVADDR, vmap_area_buf, SIZE(vmap_area), "vmap_area struct", FAULT_ON_ERROR);
		...
		if (!(vi->flags & ADDRESS_SPECIFIED) || ((vi->memtype == KVADDR) && ((vi->spec_addr >= start)
										     && (vi->spec_addr <
											 (start + size))))) {
			if (vi->flags & VMLIST_VERIFY) {
				verified++;
			...
			fprintf(fp, "%s%s  %s%s  %s - %s  %7ld\n",
				...
				space(MINSPACE - 1), mkstring(buf2, VADDR_PRLEN,
							      LONG_HEX | CENTER
							      | LJUST,
							      MKSTR(vm_struct)),
				space(MINSPACE - 1), mkstring(buf3, VADDR_PRLEN,
							      LONG_HEX | RJUST,
							      MKSTR(start)),
				mkstring(buf4, VADDR_PRLEN, LONG_HEX | LJUST, MKSTR(start + size)), size);
		}

		if ((vi->flags & ADDRESS_SPECIFIED)
		    && (vi->memtype == PHYSADDR)) {
			for (pcheck = start; pcheck < (start + size); pcheck += PAGESIZE()) {
				if (!kvtop(NULL, pcheck, &paddr, 0))
					continue;
				if ((vi->spec_addr >= paddr) && (vi->spec_addr < (paddr + PAGESIZE()))) {
					if (vi->flags & GET_PHYS_TO_VMALLOC) {
						...
						fprintf(fp,
							...
							mkstring(buf4,
								 VADDR_PRLEN,
								 LONG_HEX | LJUST, MKSTR(start + size)), size);
					break;
				}
			}
 ...
 */
static int dump_page_lists(struct meminfo *mi)
{
	int i, c, n, retval;
	...
	if (mi->flags & GET_ACTIVE_LIST) {
		if (!symbol_exists("active_list"))
			error(FATAL, "active_list does not exist in this kernel\n");

		if (symbol_exists("nr_active_pages"))
			get_symbol_data("nr_active_pages", sizeof(int), &nr_active_pages);
		else
			error(FATAL, "nr_active_pages does not exist in this kernel\n");

		ld->end = symbol_value("active_list");
		readmem(ld->end, KVADDR, &ld->start, sizeof(void *), "LIST_HEAD contents", FAULT_ON_ERROR);
		...
		if ((mi->flags & ADDRESS_SPECIFIED) && ld->searchfor) {
			...
			fprintf(fp, "%snr_active_pages: %d ", mi->flags & VERBOSE ? "\n" : "", nr_active_pages);
	...
	if (mi->flags & GET_INACTIVE_LIST) {
		if (!symbol_exists("inactive_list"))
			error(FATAL, "inactive_list does not exist in this kernel\n");

		if (symbol_exists("nr_inactive_pages"))
			get_symbol_data("nr_inactive_pages", sizeof(int), &nr_inactive_pages);
		else
			error(FATAL, "nr_active_pages does not exist in this kernel\n");
		...
		if ((mi->flags & ADDRESS_SPECIFIED) && ld->searchfor) {
			...
			fprintf(fp, "%snr_inactive_pages: %d ", mi->flags & VERBOSE ? "\n" : "", nr_inactive_pages);
	...
	if (mi->flags & GET_INACTIVE_DIRTY) {
		...
		if (symbol_exists("nr_inactive_dirty_pages"))
			get_symbol_data("nr_inactive_dirty_pages", sizeof(int), &nr_inactive_dirty_pages);
		else
			error(FATAL, "nr_inactive_dirty_pages does not exist in this kernel\n");
	...
	if (mi->flags & GET_INACTIVE_CLEAN) {
		...
		if ((mi->flags & VERBOSE) && (mi->flags & (GET_ACTIVE_LIST | GET_INACTIVE_DIRTY)))
			fprintf(fp, "\n");
		...
		for (n = 0; pgdat; n++) {
			...
			for (i = 0; i < vt->nr_zones; i++) {
				readmem(node_zones + OFFSET(zone_struct_name),
					KVADDR, &value, sizeof(void *), "zone_struct name", FAULT_ON_ERROR);
				if (!read_string(value, buf, BUFSIZE - 1))
					sprintf(buf, "(unknown) ");
				...
				if (mi->flags & VERBOSE) {
					if (vt->numnodes > 1)
						fprintf(fp, "NODE %d ", n);
					fprintf(fp, "\"%s\" inactive_clean_list:\n", buf);
				}
				...
				readmem(node_zones +
					...
					sizeof(ulong), "inactive_clean_pages", FAULT_ON_ERROR);

				readmem(node_zones +
					OFFSET(zone_struct_inactive_clean_list),
					KVADDR, &inactive_clean_list,
					sizeof(ulong), "inactive_clean_list", FAULT_ON_ERROR);

				ld->start = inactive_clean_list;
				ld->end = node_zones + OFFSET(zone_struct_inactive_clean_list);
				if (mi->flags & ADDRESS_SPECIFIED)
					ld->searchfor = mi->spec_addr;
				...
				if ((mi->flags & ADDRESS_SPECIFIED)
					...
					if (vt->numnodes > 1)
						fprintf(fp, "NODE %d ", n);
					fprintf(fp, "\"%s\" ", buf);
					fprintf(fp, "inactive_clean_pages: %ld ", inactive_clean_pages);
			...
			readmem(pgdat + OFFSET_OPTION(pglist_data_node_next,
				...
				KVADDR, &pgdat, sizeof(void *), "pglist_data node_next", FAULT_ON_ERROR);
		}
	}
...
static char *is_kmem_cache_addr(ulong vaddr, char *kbuf)
{
	...
	do {
			...
			if (vt->kmem_cache_namelen) {
				...
				if (!read_string(name, kbuf, BUFSIZE - 1)) {
					if (vt->flags & (PERCPU_KMALLOC_V1 | PERCPU_KMALLOC_V2))
						error(WARNING, "cannot read kmem_cache_s.name string at %lx\n", name);
					else
						error(WARNING, "cannot read kmem_cache_s.c_name string at %lx\n", name);
		...
		readmem(cache + next_offset, KVADDR, &cache, sizeof(long), "kmem_cache_s next", FAULT_ON_ERROR);
...
static void kmem_cache_list(void)
{
	...
	do {
		readmem(cache, KVADDR, cache_buf, SIZE(kmem_cache_s), "kmem_cache buffer", FAULT_ON_ERROR);

		if (vt->kmem_cache_namelen) {
			BCOPY(cache_buf + name_offset, buf, vt->kmem_cache_namelen);
		} else {
		...
		if (has_cache_chain && (cache == cache_chain))
			readmem(cache, KVADDR, &cache, sizeof(char *), "cache_chain", FAULT_ON_ERROR);
 ...
 */
static char *vaddr_to_kmem_cache(ulong vaddr, char *buf, int verbose)
{
	physaddr_t paddr;
	ulong page;
	ulong cache;
	...
	if (vt->flags & KMALLOC_SLUB) {
		readmem(compound_head(page) + OFFSET(page_slab),
			KVADDR, &cache, sizeof(void *), "page.slab", FAULT_ON_ERROR);
	} else if (VALID_MEMBER(page_next))
		readmem(page + OFFSET(page_next), KVADDR, &cache, sizeof(void *), "page.next", FAULT_ON_ERROR);
	else if (VALID_MEMBER(page_list_next))
		readmem(page + OFFSET(page_list_next),
			KVADDR, &cache, sizeof(void *), "page.list.next", FAULT_ON_ERROR);
	else if (VALID_MEMBER(page_lru))
		readmem(page + OFFSET(page_lru) + OFFSET(list_head_next),
			KVADDR, &cache, sizeof(void *), "page.lru.next", FAULT_ON_ERROR);
	else
 ...
 */
static ulong vaddr_to_slab(ulong vaddr)
{
	physaddr_t paddr;
	ulong page;
	ulong slab;
	...
	if (vt->flags & KMALLOC_SLUB)
		...
		readmem(page + OFFSET(page_prev), KVADDR, &slab, sizeof(void *), "page.prev", FAULT_ON_ERROR);
	else if (VALID_MEMBER(page_list_prev))
		readmem(page + OFFSET(page_list_prev), KVADDR, &slab, sizeof(void *), "page.list.prev", FAULT_ON_ERROR);
	else if (VALID_MEMBER(page_lru))
		readmem(page + OFFSET(page_lru) + OFFSET(list_head_prev),
			KVADDR, &slab, sizeof(void *), "page.lru.prev", FAULT_ON_ERROR);
	else
...
static void kmem_cache_init(void)
{
	...
	if (!strlen(slab_hdr)) {
		if (vt->flags & KMALLOC_SLUB)
			sprintf(slab_hdr,
				...
				space(VADDR_PRLEN > 8 ? 14 : 6), space(VADDR_PRLEN > 8 ? 12 : 4));
		else
			sprintf(slab_hdr,
	...
	do {
		...
		if (!readmem(cache, KVADDR, cache_buf, SIZE(kmem_cache_s), "kmem_cache buffer", RETURN_ON_ERROR)) {
			FREEBUF(cache_buf);
			vt->flags |= KMEM_CACHE_UNAVAIL;
			error(INFO, "%sunable to initialize kmem slab cache subsystem\n\n", DUMPFILE()? "\n" : "");
			hq_close();
			return;
		}
	...
	if (!(vt->flags & KMEM_CACHE_INIT)) {
		if (vt->flags & PERCPU_KMALLOC_V1)
			ARRAY_LENGTH_INIT(vt->kmem_cache_namelen,
					  kmem_cache_s_name, "kmem_cache_s.name", NULL, sizeof(char));
		else if (vt->flags & PERCPU_KMALLOC_V2)
			vt->kmem_cache_namelen = 0;
		else
			ARRAY_LENGTH_INIT(vt->kmem_cache_namelen, kmem_cache_s_c_name, "kmem_cache_s.c_name", NULL, 0);
	}
...
static ulong kmem_cache_nodelists(ulong cache)
{
	ulong nodelists = 0;
	...
	if (vt->flags & NODELISTS_IS_PTR) {
		...
		if (!readmem(cache + OFFSET(kmem_cache_s_lists), KVADDR,
			     &nodelists, sizeof(ulong), "nodelists pointer", RETURN_ON_ERROR))
...
static void kmem_cache_downsize(void)
{
	...
	if ((THIS_KERNEL_VERSION < LINUX(2, 6, 22)) ||
	    ...
	    (!MEMBER_EXISTS("kmem_cache", "buffer_size") && !MEMBER_EXISTS("kmem_cache", "size"))) {
		return;
	}
	...
	if (vt->flags & NODELISTS_IS_PTR) {
		...
		if (kernel_symbol_exists("nr_cpu_ids"))
			get_symbol_data("nr_cpu_ids", sizeof(int), &nr_cpu_ids);
		else
			nr_cpu_ids = kt->cpus;

		ARRAY_LENGTH(kmem_cache_s_array) = nr_cpu_ids;
		ASSIGN_SIZE(kmem_cache_s) = OFFSET(kmem_cache_s_array) + sizeof(ulong) * nr_cpu_ids;
		if (CRASHDEBUG(1))
	...
	buffer_size = UINT(cache_buf + MEMBER_OFFSET("kmem_cache", "buffer_size"));
	...
	if (buffer_size < SIZE(kmem_cache_s)) {
		...
		if (buffer_size >= (uint) (OFFSET(kmem_cache_s_lists) + (sizeof(void *) * vt->kmem_cache_len_nodes)))
			ASSIGN_SIZE(kmem_cache_s) = buffer_size;
		else
			error(WARNING, "questionable cache_cache.buffer_size: %d\n", buffer_size);

		if (CRASHDEBUG(1)) {
			fprintf(fp,
				"\nkmem_cache_downsize: SIZE(kmem_cache_s): %ld "
				"cache_cache.buffer_size: %d\n", STRUCT_SIZE("kmem_cache"), buffer_size);
			fprintf(fp, "kmem_cache_downsize: nr_node_ids: %ld\n", vt->kmem_cache_len_nodes);
		}
	}
 ...
 */
static ulong max_cpudata_limit(ulong cache, ulong * cpus)
{
	int i;
	ulong cpudata[NR_CPUS];
	int limit;
	...
	if (!readmem(cache + OFFSET(kmem_cache_s_cpudata),
		     KVADDR, &cpudata[0],
		     sizeof(ulong) * ARRAY_LENGTH(kmem_cache_s_cpudata), "cpudata array", RETURN_ON_ERROR))
		goto bail_out;

	for (i = max_limit = 0; (i < ARRAY_LENGTH(kmem_cache_s_cpudata)) && cpudata[i]; i++) {
		if (!readmem(cpudata[i] + OFFSET(cpucache_s_limit),
			     KVADDR, &limit, sizeof(int), "cpucache limit", RETURN_ON_ERROR))
			goto bail_out;
		if (limit > max_limit)
			max_limit = limit;
	}
 ...
 kmem_cache_s_array:
	...
	if (!readmem(cache + OFFSET(kmem_cache_s_array),
		     KVADDR, &cpudata[0],
		     sizeof(ulong) * ARRAY_LENGTH(kmem_cache_s_array), "array cache array", RETURN_ON_ERROR))
		goto bail_out;

	for (i = max_limit = 0; (i < ARRAY_LENGTH(kmem_cache_s_array)) && cpudata[i]; i++) {
		if (!readmem(cpudata[i] + OFFSET(array_cache_limit),
			     KVADDR, &limit, sizeof(int), "array cache limit", RETURN_ON_ERROR))
			goto bail_out;
		if (limit > max_limit)
			max_limit = limit;
	}
	...
	if (VALID_MEMBER(kmem_list3_shared) &&
	    ...
	    readmem(cache + OFFSET(kmem_cache_s_lists) +
		    OFFSET(kmem_list3_shared), KVADDR, &shared, sizeof(void *),
		    "kmem_list3 shared", RETURN_ON_ERROR | QUIET)
	    && readmem(shared + OFFSET(array_cache_limit), KVADDR, &limit,
		       sizeof(int), "shared array_cache limit", RETURN_ON_ERROR | QUIET)) {
		if (limit > max_limit)
			max_limit = limit;
	}
	...
	*cpus = i;
	...
	if (VALID_MEMBER(kmem_list3_shared) && VALID_MEMBER(kmem_cache_s_lists)
	    && readmem(kmem_cache_nodelists(cache), KVADDR, &start_address[0],
		       sizeof(ulong) * vt->kmem_cache_len_nodes, "array nodelist array", RETURN_ON_ERROR)) {
		for (i = 0; i < vt->kmem_cache_len_nodes; i++) {
			if (start_address[i] == 0)
				continue;
			if (readmem
			    (start_address[i] + OFFSET(kmem_list3_shared),
			     KVADDR, &shared, sizeof(void *), "kmem_list3 shared", RETURN_ON_ERROR | QUIET)) {
				if (!shared)
					break;
			} else
				continue;
			if (readmem(shared + OFFSET(array_cache_limit),
				    KVADDR, &limit, sizeof(int), "shared array_cache limit", RETURN_ON_ERROR | QUIET)) {
				if (CRASHDEBUG(3))
					fprintf(fp, "  shared node limit[%d]: %d\n", i, limit);
				if (limit > max_limit)
					max_limit = limit;
				break;
			}
 ...
 *  command entry.
 */
static int ignore_cache(struct meminfo *si, char *name)
{
	int i, argc;
	char *p1;
...
static void dump_kmem_cache_info_v2(struct meminfo *si)
{
	char b1[BUFSIZE];
	char b2[BUFSIZE];
	int namelen, sizelen, spacelen;

	fprintf(fp, "%s ", mkstring(b1, VADDR_PRLEN, LJUST | LONG_HEX, MKSTR(si->cache)));
	...
	if (namelen++ > 18) {
		...
		fprintf(fp, "%s%s%ld  ", si->curname, space(spacelen <= 0 ? 1 : spacelen), si->size);
		if (spacelen > 0)
			spacelen = 1;
	...
	fprintf(fp, b1, vt->flags & (PERCPU_KMALLOC_V2) ? si->inuse - si->cpucached_cache : si->inuse);
...
static void dump_kmem_cache(struct meminfo *si)
{
	char buf[BUFSIZE];
	char kbuf[BUFSIZE];
	char *reqname;
	...
	if (vt->flags & (PERCPU_KMALLOC_V1 | PERCPU_KMALLOC_V2))
		error(FATAL, "dump_kmem_cache called with PERCPU_KMALLOC_V[12] set\n");
	...
	if (si->flags & CACHE_SET) {
		readmem(si->cache + OFFSET(kmem_cache_s_c_nextp),
			KVADDR, &cache_cache, sizeof(ulong), "kmem_cache next", FAULT_ON_ERROR);
	} else
		si->cache = cache_cache = symbol_value("cache_cache");

	if (si->flags & ADDRESS_SPECIFIED) {
		if (!(p1 = vaddr_to_kmem_cache(si->spec_addr, kbuf, VERBOSE))) {
			error(INFO, "address is not allocated in slab subsystem: %lx\n", si->spec_addr);
			return;
		}
	...
	do {
		if ((si->flags & VERBOSE) && !si->reqname && !(si->flags & ADDRESS_SPECIFIED))
			fprintf(fp, "%s%s", cnt++ ? "\n" : "", kmem_cache_hdr);

		readmem(si->cache, KVADDR, si->cache_buf, SIZE(kmem_cache_s), "kmem_cache buffer", FAULT_ON_ERROR);

		if (vt->kmem_cache_namelen) {
			BCOPY(si->cache_buf + OFFSET(kmem_cache_s_c_name), buf, vt->kmem_cache_namelen);
		} else {
			name = ULONG(si->cache_buf + OFFSET(kmem_cache_s_c_name));
			if (!read_string(name, buf, BUFSIZE - 1)) {
				error(WARNING, "cannot read kmem_cache_s.c_name string at %lx\n", name);
				sprintf(buf, "(unknown)");
			}
		...
		if (magic == SLAB_C_MAGIC) {
			...
			si->size = ULONG(si->cache_buf + OFFSET(kmem_cache_s_c_org_size));
			if (!si->size) {
				if (STREQ(si->curname, "kmem_cache"))
					si->size = SIZE(kmem_cache_s);
				else {
					error(INFO, "\"%s\" cache: c_org_size: %ld\n", si->curname, si->size);
					si->errors++;
				}
			}
			si->c_flags = ULONG(si->cache_buf + OFFSET(kmem_cache_s_c_flags));
			si->c_offset = ULONG(si->cache_buf + OFFSET(kmem_cache_s_c_offset));
			si->order = ULONG(si->cache_buf + OFFSET(kmem_cache_s_c_gfporder));
			si->c_num = ULONG(si->cache_buf + OFFSET(kmem_cache_s_c_num));
			...
			if (si->flags == GET_SLAB_PAGES)
				si->retval += (si->num_slabs * (si->slabsize / PAGESIZE()));

			if (si->flags & (VERBOSE | ADDRESS_SPECIFIED)) {
				si->slab = (si->flags & ADDRESS_SPECIFIED) ? vaddr_to_slab(si->spec_addr) : 0;
				...
				if (si->found) {
					...
					case KMEM_BUFCTL_ADDR:
						fprintf(fp, "   %lx ", (ulong) si->spec_addr);
						fprintf(fp, "(ON-SLAB kmem_bufctl_t)\n");
						break;

					case KMEM_SLAB_ADDR:
						fprintf(fp, "   %lx ", (ulong) si->spec_addr);
						fprintf(fp, "(ON-SLAB kmem_slab_t)\n");
						break;
					...
					case KMEM_OBJECT_ADDR_FREE:
						...
						fprintf(fp, "   %lx\n",
							si->container ? si->container : (ulong) si->spec_addr);
						break;
...
static void dump_kmem_cache_percpu_v1(struct meminfo *si)
{
	int i;
	char buf[BUFSIZE];
	char kbuf[BUFSIZE];
	...
	if (si->flags & CACHE_SET) {
		readmem(si->cache + OFFSET(kmem_cache_s_next),
			KVADDR, &cache_cache, sizeof(ulong), "kmem_cache_s next", FAULT_ON_ERROR);
	} else
		si->cache = cache_cache = symbol_value("cache_cache");
	...
	do {
		...
		if (vt->kmem_cache_namelen) {
			readmem(si->cache + OFFSET(kmem_cache_s_name),
				KVADDR, buf, vt->kmem_cache_namelen, "name array", FAULT_ON_ERROR);
		} else {
			readmem(si->cache + OFFSET(kmem_cache_s_name),
				KVADDR, &name, sizeof(ulong), "name", FAULT_ON_ERROR);
			if (!read_string(name, buf, BUFSIZE - 1)) {
				error(WARNING, "cannot read kmem_cache_s.name string at %lx\n", name);
				sprintf(buf, "(unknown)");
			}
		...
		readmem(si->cache + OFFSET(kmem_cache_s_objsize),
			KVADDR, &tmp_val, sizeof(uint), "objsize", FAULT_ON_ERROR);
		...
		readmem(si->cache + OFFSET(kmem_cache_s_flags),
			KVADDR, &tmp_val, sizeof(uint), "kmem_cache_s flags", FAULT_ON_ERROR);
		si->c_flags = (ulong) tmp_val;

		readmem(si->cache + OFFSET(kmem_cache_s_gfporder),
			KVADDR, &tmp_val, sizeof(uint), "gfporder", FAULT_ON_ERROR);
		...
		if (si->flags & (VERBOSE | ADDRESS_SPECIFIED)) {
			...
			if (si->found) {
				...
				case KMEM_OBJECT_ADDR_CACHED:
					...
					fprintf(fp,
						"   %lx  (cpu %d cache)\n",
						si->container ? si->container : (ulong) si->spec_addr, si->cpu);
					break;
				}
 ...
 next_cache:
		readmem(si->cache + OFFSET(kmem_cache_s_next),
			KVADDR, &si->cache, sizeof(ulong), "kmem_cache_s next", FAULT_ON_ERROR);
 ...
 */
static void dump_kmem_cache_percpu_v2(struct meminfo *si)
{
	int i;
	char buf[BUFSIZE];
	char kbuf[BUFSIZE];
	...
	if (!(vt->flags & PERCPU_KMALLOC_V2))
		error(FATAL, "dump_kmem_cache_percpu called without PERCPU_KMALLOC_V2\n");
	...
	if (vt->flags & PERCPU_KMALLOC_V2_NODES)
		si->shared_array_cache = (ulong *)
		    GETBUF(vt->kmem_cache_len_nodes * (vt->kmem_max_limit + 1) * sizeof(ulong));
	else
		si->shared_array_cache = (ulong *)
	...
	if (si->flags & CACHE_SET)
		readmem(si->cache + OFFSET(kmem_cache_s_next),
			KVADDR, &cache_end, sizeof(ulong), "kmem_cache_s next", FAULT_ON_ERROR);
	else {
...
static void do_slab_chain(int cmd, struct meminfo *si)
{
	ulong tmp, magic;
	ulong kmem_slab_end;
	...
	case SLAB_GET_COUNTS:
		...
		do {
			...
			readmem(si->slab, KVADDR, kmem_slab_s_buf,
				SIZE(kmem_slab_s), "kmem_slab_s buffer", FAULT_ON_ERROR);

			magic = ULONG(kmem_slab_s_buf + OFFSET(kmem_slab_s_s_magic));

			if (magic == SLAB_MAGIC_ALLOC) {

				tmp = ULONG(kmem_slab_s_buf + OFFSET(kmem_slab_s_s_inuse));

				si->inuse += tmp;
				si->num_slabs++;
			} else {
				fprintf(fp, "\"%s\" cache: invalid s_magic: %lx\n", si->curname, magic);
				si->errors++;
				FREEBUF(kmem_slab_s_buf);
				return;
			}

			si->slab = ULONG(kmem_slab_s_buf + OFFSET(kmem_slab_s_s_nextp));
...
static void do_slab_chain_percpu_v1(long cmd, struct meminfo *si)
{
	int i, tmp, s;
	int list_borked;
	char *slab_s_buf;
	...
	case SLAB_GET_COUNTS:
		...
		for (s = 0; s < SLAB_CHAINS; s++) {
			...
			if (!readmem(slab_chains[s],
				     KVADDR, &si->slab, sizeof(ulong), "first slab", QUIET | RETURN_ON_ERROR)) {
				error(INFO,
				      "%s: %s list: bad slab pointer: %lx\n",
				      si->curname, slab_chain_name_v1[s], slab_chains[s]);
				list_borked = 1;
				continue;
			}
			...
			do {
				...
				readmem(si->slab, KVADDR, slab_s_buf, SIZE(slab_s), "slab_s buffer", FAULT_ON_ERROR);
				...
				si->s_mem = ULONG(slab_s_buf + OFFSET(slab_s_s_mem));
				gather_slab_cached_count(si);

				si->num_slabs++;

				si->slab = ULONG(slab_s_buf + OFFSET(slab_s_list));
	...
	case SLAB_WALKTHROUGH:
		...
		for (s = 0; s < SLAB_CHAINS; s++) {
			...
			if (!specified_slab) {
				if (!readmem(slab_chains[s],
					     KVADDR, &si->slab, sizeof(ulong), "slabs", QUIET | RETURN_ON_ERROR)) {
					error(INFO,
					      "%s: %s list: bad slab pointer: %lx\n",
					      si->curname, slab_chain_name_v1[s], slab_chains[s]);
					list_borked = 1;
			...
			do {
				...
				readmem(si->slab + OFFSET(slab_s_list),
					KVADDR, &si->slab, sizeof(ulong), "slab list", FAULT_ON_ERROR);
...
static int verify_slab_v1(struct meminfo *si, ulong last, int s)
{
	...
	if (!readmem(si->slab, KVADDR, slab_s_buf, SIZE(slab_s), "slab_s buffer", QUIET | RETURN_ON_ERROR)) {
	...
	if (!IS_KVADDR((ulong) list_head->next) || !accessible((ulong) list_head->next)) {
	...
	if (last && (last != (ulong) list_head->prev)) {
		error(INFO, "%s: %s list: slab: %lx  bad prev pointer: %lx\n",
		      si->curname, list, si->slab, (ulong) list_head->prev);
		errcnt++;
	}
...
static void do_slab_chain_percpu_v2(long cmd, struct meminfo *si)
{
	int i, tmp, s;
	int list_borked;
	char *slab_buf;
	...
	slab_chains[0] = si->cache + OFFSET(kmem_cache_s_lists) + OFFSET(kmem_list3_slabs_partial);
	slab_chains[1] = si->cache + OFFSET(kmem_cache_s_lists) + OFFSET(kmem_list3_slabs_full);
	slab_chains[2] = si->cache + OFFSET(kmem_cache_s_lists) + OFFSET(kmem_list3_slabs_free);
	...
	case SLAB_GET_COUNTS:
		...
		for (s = 0; s < SLAB_CHAINS; s++) {
			...
			if (!readmem(slab_chains[s],
				...
				error(INFO,
				      "%s: %s list: bad slab pointer: %lx\n",
				      si->curname, slab_chain_name_v2[s], slab_chains[s]);
				list_borked = 1;
				continue;
			}
			...
			do {
				...
				readmem(si->slab, KVADDR, slab_buf, SIZE(slab), "slab buffer", FAULT_ON_ERROR);
				...
				si->s_mem = ULONG(slab_buf + OFFSET(slab_s_mem));
				gather_slab_cached_count(si);

				si->num_slabs++;

				si->slab = ULONG(slab_buf + OFFSET(slab_list));
				...
				for (i = 0; i < SLAB_CHAINS; i++) {
					if ((i != s)
						...
						error(NOTE,
						      "%s: slab chain inconsistency: %s list\n",
						      si->curname, slab_chain_name_v2[s]);
						list_borked = 1;
					}
				}
...
static void do_slab_chain_percpu_v2_nodes(long cmd, struct meminfo *si)
{
	int i, tmp, s, node;
	int list_borked;
	char *slab_buf;
		...
		for (index = 0; (index < vt->kmem_cache_len_nodes); index++) {
			...
			for (s = 0; s < SLAB_CHAINS; s++) {
				...
				if (!specified_slab) {
					if (!readmem(slab_chains[s],
						     KVADDR, &si->slab,
						     sizeof(ulong), "slabs", QUIET | RETURN_ON_ERROR)) {
						error(INFO,
						      "%s: %s list: bad slab pointer: %lx\n",
						      si->curname, slab_chain_name_v2[s], slab_chains[s]);
						list_borked = 1;
 ...
 *  Try to preclude any attempt to translate a bogus slab structure.
 */
static int verify_slab_v2(struct meminfo *si, ulong last, int s)
{
...
static void save_slab_data(struct meminfo *si)
{
	int i;
...
static int slab_data_saved(struct meminfo *si)
{
	int i;
...
static void dump_saved_slab_data(void)
{
	...
	for (i = 0; i < vt->kmem_cache_count; i++) {
		...
		fprintf(fp,
			...
			vt->slab_data[i].inuse, vt->slab_data[i].num_slabs, vt->slab_data[i].cpucached_cache);
	}
}
...
static void dump_slab(struct meminfo *si)
{
...
static void dump_slab_percpu_v1(struct meminfo *si)
{
	int tmp;

	readmem(si->slab + OFFSET(slab_s_s_mem), KVADDR, &si->s_mem, sizeof(ulong), "s_mem", FAULT_ON_ERROR);
	...
	if (si->flags & ADDRESS_SPECIFIED) {
		if (INSLAB_PERCPU(si->slab, si) && (si->spec_addr >= si->slab)
	...
	readmem(si->slab + OFFSET(slab_s_inuse), KVADDR, &tmp, sizeof(int), "inuse", FAULT_ON_ERROR);
	si->s_inuse = tmp;

	readmem(si->slab + OFFSET(slab_s_free),
		KVADDR, &si->free, SIZE(kmem_bufctl_t), "kmem_bufctl_t", FAULT_ON_ERROR);
 ...
 *  Updated for 2.6 slab substructure.
 */
static void dump_slab_percpu_v2(struct meminfo *si)
{
	int tmp;

	readmem(si->slab + OFFSET(slab_s_mem), KVADDR, &si->s_mem, sizeof(ulong), "s_mem", FAULT_ON_ERROR);
	...
	readmem(si->slab + OFFSET(slab_inuse), KVADDR, &tmp, sizeof(int), "inuse", FAULT_ON_ERROR);
	si->s_inuse = tmp;

	readmem(si->slab + OFFSET(slab_free), KVADDR, &si->free, SIZE(kmem_bufctl_t), "kmem_bufctl_t", FAULT_ON_ERROR);
...
static void gather_slab_free_list(struct meminfo *si)
{
	ulong *next, obj;
	ulong expected, cnt;
	...
	do {
		...
		if (cnt == si->c_num) {
			error(INFO, "\"%s\" cache: too many objects found in slab free list\n", si->curname);
			si->errors++;
			return;
		}
		...
		if (si->flags & ADDRESS_SPECIFIED) {
			if (INSLAB(next, si) && (si->spec_addr >= (ulong) next) && (si->spec_addr < (ulong) (next + 1))) {
				si->found = KMEM_BUFCTL_ADDR;
				return;
			}
		}
		...
		if (!INSLAB(obj, si)) {
			error(INFO, "\"%s\" cache: address not contained within slab: %lx\n", si->curname, obj);
			si->errors++;
		}

		readmem((ulong) next, KVADDR, &next, sizeof(void *), "s_freep chain entry", FAULT_ON_ERROR);
	} while (next);
...
static void gather_slab_free_list_percpu(struct meminfo *si)
{
	int i;
	ulong obj;
	ulong expected, cnt;
	...
	readmem((ulong) kmembp, KVADDR, si->kmem_bufctl,
		SIZE(kmem_bufctl_t) * si->c_num, "kmem_bufctl array", FAULT_ON_ERROR);
	...
	if (CRASHDEBUG(1)) {
		...
		for (kbp = (short *)&si->kmem_bufctl[0], i = 0;
		     (SIZE(kmem_bufctl_t) == sizeof(short)) && (i < si->c_num); i++)
			fprintf(fp, "%d ", *(kbp + i));
	...
	if (SIZE(kmem_bufctl_t) == sizeof(int)) {
		for (free_index = si->free; free_index != BUFCTL_END; free_index = si->kmem_bufctl[free_index]) {
		...
		for (free_index = si->free; free_index != BUFCTL_END; free_index = (int)*(kbp + free_index)) {
...
static void dump_slab_objects(struct meminfo *si)
{
	int i, j;
	ulong *next;
	int on_free_list;
	...
	if (si->c_flags & SLAB_CFLGS_BUFCTL) {
		 ...
		 */
		readmem(si->slab + OFFSET(kmem_slab_s_s_mem), KVADDR, &obj, sizeof(ulong), "s_mem", FAULT_ON_ERROR);
		...
		for (i = 0; i < si->c_num; i++) {
			...
			if (si->flags & ADDRESS_SPECIFIED) {
				...
				if ((si->spec_addr >= bufctl) && (si->spec_addr < (bufctl + SIZE(kmem_bufctl_t)))) {
					si->found = KMEM_BUFCTL_ADDR;
					return;
				}
			}
...
static void dump_slab_objects_percpu(struct meminfo *si)
{
	int i, j;
	...
	for (i = 0, obj = si->s_mem; i < si->c_num; i++, obj += si->size) {
		...
		if (on_free_list && on_shared_list) {
			error(INFO, "\"%s\" cache: object %lx on both free and shared lists\n", si->curname, obj);
			si->errors++;
		}
		...
		if (on_free_list) {
			...
			if (si->flags & ADDRESS_SPECIFIED) {
				if (INOBJECT(si->spec_addr, obj)) {
					si->found = KMEM_OBJECT_ADDR_FREE;
					si->container = obj;
					return;
				}
			}
			...
			if (si->flags & ADDRESS_SPECIFIED) {
				if (INOBJECT(si->spec_addr, obj)) {
					si->found = KMEM_OBJECT_ADDR_CACHED;
					si->container = obj;
					return;
				}
			}
			...
			if (si->flags & ADDRESS_SPECIFIED) {
				if (INOBJECT(si->spec_addr, obj)) {
					si->found = KMEM_OBJECT_ADDR_SHARED;
					si->container = obj;
					return;
				}
			}
			...
			if (si->flags & ADDRESS_SPECIFIED) {
				if (INOBJECT(si->spec_addr, obj)) {
					si->found = KMEM_OBJECT_ADDR_INUSE;
					si->container = obj;
					return;
				}
			}
...
static void gather_slab_cached_count(struct meminfo *si)
{
	int i;
	ulong obj;
...
static void gather_cpudata_list_v1(struct meminfo *si)
{
	int i, j;
	int avail;
	ulong cpudata[NR_CPUS];
	...
	readmem(si->cache + OFFSET(kmem_cache_s_cpudata),
		KVADDR, &cpudata[0],
		sizeof(ulong) * ARRAY_LENGTH(kmem_cache_s_cpudata), "cpudata array", FAULT_ON_ERROR);

	for (i = 0; (i < ARRAY_LENGTH(kmem_cache_s_cpudata)) && cpudata[i]; i++) {
		BZERO(si->cpudata[i], sizeof(ulong) * vt->kmem_max_limit);

		readmem(cpudata[i] + OFFSET(cpucache_s_avail),
			KVADDR, &avail, sizeof(int), "cpucache avail", FAULT_ON_ERROR);
		...
		readmem(cpudata[i] + SIZE(cpucache_s),
			KVADDR, si->cpudata[i], sizeof(void *) * avail, "cpucache avail", FAULT_ON_ERROR);
 ...
 */
static void gather_cpudata_list_v2(struct meminfo *si)
{
	int i, j;
	int avail;
	ulong cpudata[NR_CPUS];
	...
	readmem(si->cache + OFFSET(kmem_cache_s_array),
		KVADDR, &cpudata[0],
		sizeof(ulong) * ARRAY_LENGTH(kmem_cache_s_array), "array_cache array", FAULT_ON_ERROR);

	for (i = 0; (i < ARRAY_LENGTH(kmem_cache_s_array)) && cpudata[i]; i++) {
		BZERO(si->cpudata[i], sizeof(ulong) * vt->kmem_max_limit);

		readmem(cpudata[i] + OFFSET(array_cache_avail),
			KVADDR, &avail, sizeof(int), "array cache avail", FAULT_ON_ERROR);
		...
		readmem(cpudata[i] + SIZE(array_cache),
			KVADDR, si->cpudata[i], sizeof(void *) * avail, "array_cache avail", FAULT_ON_ERROR);
	...
	if (!VALID_MEMBER(kmem_list3_shared) ||
	    ...
	    !readmem(si->cache + OFFSET(kmem_cache_s_lists) +
		     OFFSET(kmem_list3_shared), KVADDR, &shared,
		     sizeof(void *), "kmem_list3 shared", RETURN_ON_ERROR | QUIET)
	    || !readmem(shared + OFFSET(array_cache_avail), KVADDR, &avail,
			sizeof(int), "shared array_cache avail", RETURN_ON_ERROR | QUIET) || !avail)
		return;
	...
	readmem(shared + SIZE(array_cache), KVADDR, si->shared_array_cache,
		sizeof(void *) * avail, "shared array_cache avail", FAULT_ON_ERROR);
 ...
 */
static void gather_cpudata_list_v2_nodes(struct meminfo *si, int index)
{
	int i, j;
	int avail;
	ulong cpudata[NR_CPUS];
	...
	start_address = (ulong *) GETBUF(sizeof(ulong) * vt->kmem_cache_len_nodes);
	readmem(si->cache + OFFSET(kmem_cache_s_array), KVADDR, &cpudata[0],
		sizeof(ulong) * ARRAY_LENGTH(kmem_cache_s_array), "array_cache array", FAULT_ON_ERROR);

	for (i = 0; (i < ARRAY_LENGTH(kmem_cache_s_array)) && (cpudata[i]) && !(index); i++) {
		if (si->cpudata[i])
			BZERO(si->cpudata[i], sizeof(ulong) * vt->kmem_max_limit);
		else
			continue;
	...
	if (!readmem
	    (kmem_cache_nodelists(si->cache), KVADDR, &start_address[0],
	     sizeof(ulong) * vt->kmem_cache_len_nodes, "array nodelist array", RETURN_ON_ERROR)
	    || !readmem(start_address[index] + OFFSET(kmem_list3_shared),
			KVADDR, &shared, sizeof(void *), "kmem_list3 shared",
			RETURN_ON_ERROR | QUIET) || !shared
	    || !readmem(shared + OFFSET(array_cache_avail), KVADDR, &avail,
			sizeof(int), "shared array_cache avail", RETURN_ON_ERROR | QUIET) || !avail) {
		FREEBUF(start_address);
		return;
	...
	readmem(shared + SIZE(array_cache), KVADDR,
		si->shared_array_cache + si->current_cache_index,
		sizeof(void *) * avail, "shared array_cache avail", FAULT_ON_ERROR);

	if ((si->current_cache_index + avail) > (vt->kmem_max_limit * vt->kmem_cache_len_nodes)) {
		error(INFO,
		      "\"%s\" cache: total shared array_cache.avail %d greater than total limit %ld\n",
		      si->curname, si->current_cache_index + avail, vt->kmem_max_limit * vt->kmem_cache_len_nodes);
		si->errors++;
		FREEBUF(start_address);
		return;
	}
...
static int check_cpudata_list(struct meminfo *si, ulong obj)
{
	int i, j;
...
static int check_shared_list(struct meminfo *si, ulong obj)
{
	int i;

	if (INVALID_MEMBER(kmem_list3_shared) || !si->shared_array_cache)
		return FALSE;
 ...
 *  mem_map page data.
 */
static void kmem_search(struct meminfo *mi)
{
	struct syment *sp;
	...
	case PHYSADDR:
		vaddr = mi->spec_addr < VTOP(vt->high_memory) ? PTOV(mi->spec_addr) : BADADDR;
		break;
	}
	 ...
	 */
	if (((vaddr >= kt->stext) && (vaddr <= kt->end)) || IS_MODULE_VADDR(mi->spec_addr)) {
	 ...
	 */
	if ((mi->memtype == KVADDR) && (task = vaddr_in_task_struct(vaddr)) && (tc = task_to_context(task))) {
		show_context(tc);
		fprintf(fp, "\n");
	} else if ((mi->memtype == KVADDR) && (task = stkptr_to_task(vaddr)) && (tc = task_to_context(task))) {
		show_context(tc);
		fprintf(fp, "\n");
	}
 ...
 */
int is_page_ptr(ulong addr, physaddr_t * phys)
{
	int n;
	ulong ppstart, ppend;
	struct node_table *nt;
 ...
 */
static int page_to_phys(ulong pp, physaddr_t * phys)
{
 ...
 *  for handling it.
 */
int read_string(ulong kvaddr, char *buf, int maxlen)
{
	int i;

	BZERO(buf, maxlen);

	readmem(kvaddr, KVADDR, buf, maxlen, "read_string characters", QUIET | RETURN_ON_ERROR);
 ...
 *  "help -v" output
 */
void dump_vm_table(int verbose)
{
	int i;
	struct node_table *nt;
	int others;
	...
	others = 0;
	fprintf(fp, "              flags: %lx  %s(", vt->flags, count_bits_long(vt->flags) > 4 ? "\n " : "");
	if (vt->flags & NODES)
 ...
 */
void dump_vma_cache(ulong verbose)
{
	int i;
	ulong vhits;
	...
	for (i = 0; i < VMA_CACHE; i++)
		fprintf(fp, "     cached_vma[%2d]: %lx (%ld)\n", i, vt->cached_vma[i], vt->cached_vma_hits[i]);
 ...
 show_hits:
	if (vt->vma_cache_fills) {
		...
		fprintf(stderr, "%s       vma hit rate: %2ld%% (%ld of %ld)\n",
			verbose ? "" : "  ", (vhits * 100) / vt->vma_cache_fills, vhits, vt->vma_cache_fills);
	}
}
 ...
 */
int vaddr_type(ulong vaddr, struct task_context *tc)
{
	int memtype, found;
 ...
 */
static int address_space_start(struct task_context *tc, ulong * addr)
{
	ulong vma;
	char *vma_buf;
...
int generic_get_kvaddr_ranges(struct vaddr_range *rp)
{
	int cnt;
...
#define ushort_overflow(VALUE) ((VALUE) > 0xffffUL)
	...
	if (CRASHDEBUG(1)) {
		...
		for (i = 0; i < ranges; i++) {
			fprintf(fp, "  [%d] %lx %lx ", i, vrp[i].start, vrp[i].end);
			switch (vrp[i].type) {
	...
	while ((c = getopt(argcnt, args, "tl:ukKVps:e:v:m:hwcx:")) != EOF) {
		...
		case 'p':
			if (XEN_HYPER_MODE())
				error(FATAL, "-p option is not applicable to the " "Xen hypervisor\n");
		...
		case 'k':
			if (XEN_HYPER_MODE())
				error(FATAL, "-%c option is not applicable to the " "Xen hypervisor\n", c);
		...
		case 'h':
			if (searchinfo.mode != SEARCH_DEFAULT)
				error(INFO, "WARNING: overriding previously" " set search mode with \"h\"\n");
			searchinfo.mode = SEARCH_USHORT;
			break;

		case 'w':
			if (searchinfo.mode != SEARCH_DEFAULT)
				error(INFO, "WARNING: overriding previously" " set search mode with \"w\"\n");
			searchinfo.mode = SEARCH_UINT;
			break;

		case 'c':
			if (searchinfo.mode != SEARCH_DEFAULT)
				error(INFO, "WARNING: overriding previously" " set search type with \"c\"\n");
		...
		case 't':
			if (XEN_HYPER_MODE())
				error(FATAL, "-t option is not applicable to the " "Xen hypervisor\n");
			tflag++;
			break;
	...
	if (tflag && (memtype || start || end || len))
		error(FATAL, "-t option cannot be used with other " "memory-selection options\n");

	if (XEN_HYPER_MODE()) {
		memtype = KVADDR;
		if (!sflag)
			error(FATAL, "the \"-s start\" option is required for" " the Xen hypervisor\n");
	} else if (!memtype) {
		memtype = KVADDR;
		if (!tflag && !sflag++)
			start = vrp[0].start;
	...
	if (argerrs || (!sflag && !tflag) || !args[optind] || (len && end) || !memtype)
		cmd_usage(pc->curcmd, SYNOPSIS);
	...
	switch (memtype) {
	case UVADDR:
		if (vaddr_overflow(start) || !IS_UVADDR((ulong) start, CURRENT_CONTEXT())) {
			error(INFO, "invalid user virtual address: %llx\n", start);
			cmd_usage(pc->curcmd, SYNOPSIS);
		}
		break;
	...
	case KVADDR:
		if (tflag)
			break;
		if (vaddr_overflow(start) || !IS_KVADDR((ulong) start)) {
			error(INFO, "invalid kernel virtual address: %llx\n", (ulonglong) start);
			cmd_usage(pc->curcmd, SYNOPSIS);
		}
		break;
	...
	case AMBIGUOUS:
		error(INFO, "ambiguous virtual address: %llx  (requires -u or -k)\n", (ulonglong) start);
		cmd_usage(pc->curcmd, SYNOPSIS);
	}
	...
	case UVADDR:
		...
		if (end > (ulonglong) uvaddr_end) {
			error(INFO, "ending address %lx is in kernel space: %llx\n", end);
			cmd_usage(pc->curcmd, SYNOPSIS);
		}
		...
		if (uvaddr_end < uvaddr_start) {
			error(INFO, "ending address %lx is below starting address %lx\n", uvaddr_end, uvaddr_start);
			cmd_usage(pc->curcmd, SYNOPSIS);
		}
		break;
	...
	if (context) {
		...
		if (context > max)
			error(FATAL, "context value %d is too large: maximum is %d\n", context, max);
	...
	while (args[optind]) {
		...
		case SEARCH_ULONG:
			if (can_eval(args[optind])) {
				...
				searchinfo.s_parms.s_ulong.opt_string[searchinfo.vcnt] = mask ? NULL : args[optind];
		...
		case SEARCH_UINT:
			if (can_eval(args[optind])) {
				value = eval(args[optind], FAULT_ON_ERROR, NULL);
				searchinfo.s_parms.s_uint.opt_string[searchinfo.vcnt] = mask ? NULL : args[optind];
			} else if (symbol_exists(args[optind])) {
				value = symbol_value(args[optind]);
				searchinfo.s_parms.s_uint.opt_string[searchinfo.vcnt] = mask ? NULL : args[optind];
			} else
			...
			if (uint_overflow(value))
				error(FATAL,
				      "value too large for -w option: %lx %s\n", value, show_opt_string(&searchinfo));
			searchinfo.vcnt++;
			break;
		...
		case SEARCH_USHORT:
			if (can_eval(args[optind])) {
				value = eval(args[optind], FAULT_ON_ERROR, NULL);
				searchinfo.s_parms.s_ushort.opt_string[searchinfo.vcnt] = mask ? NULL : args[optind];
			} else if (symbol_exists(args[optind])) {
				value = symbol_value(args[optind]);
				searchinfo.s_parms.s_ushort.opt_string[searchinfo.vcnt] = mask ? NULL : args[optind];
			} else
			...
			if (ushort_overflow(value))
				error(FATAL,
				      "value too large for -h option: %lx %s\n", value, show_opt_string(&searchinfo));
			searchinfo.vcnt++;
			break;
		...
		case SEARCH_CHARS:
			...
			if (strlen(args[optind])) {
				searchinfo.s_parms.s_chars.value[searchinfo.vcnt] = args[optind];
				searchinfo.s_parms.s_chars.len[searchinfo.vcnt] = strlen(args[optind]);
				searchinfo.vcnt++;
			}
			break;
		}
	...
	case KVADDR:
		...
		for (i = 0; i < ranges; i++) {
			...
			searchinfo.vaddr_start = kvaddr_start > vrp[i].start ? kvaddr_start : vrp[i].start;
			searchinfo.vaddr_end = (kvaddr_end < vrp[i].end) ? kvaddr_end : vrp[i].end;
			search_virtual(&searchinfo);
		}
		break;
	}
...
static char *show_opt_string(struct searchinfo *si)
{
	char *opt_string;
	int index;
...
static void display_with_pre_and_post(void *bufptr, ulonglong addr, struct searchinfo *si)
{
	...
	switch (si->mode) {
	case SEARCH_ULONG:
		fprintf(fp, "%lx %s\n", *((ulong *) bufptr), show_opt_string(si));
		break;
	case SEARCH_UINT:
		fprintf(fp, "%x %s\n", *((uint *) bufptr), show_opt_string(si));
		break;
	case SEARCH_USHORT:
		fprintf(fp, "%x %s\n", *((ushort *) bufptr), show_opt_string(si));
		break;
	}
...
static ulong search_ulong(ulong * bufptr, ulong addr, int longcnt, struct searchinfo *si)
{
	int i;
	ulong mask = si->s_parms.s_ulong.mask;
	for (i = 0; i < longcnt; i++, bufptr++, addr += sizeof(long)) {
		for (si->val = 0; si->val < si->vcnt; si->val++) {
			if (SEARCHMASK(*bufptr) == SEARCHMASK(si->s_parms.s_ulong.value[si->val])) {
...
static ulonglong search_ulong_p(ulong * bufptr, ulonglong addr, int longcnt, struct searchinfo *si)
{
	int i;
	ulong mask = si->s_parms.s_ulong.mask;
	for (i = 0; i < longcnt; i++, bufptr++, addr += sizeof(long)) {
...
static ulong search_uint(ulong * bufptr, ulong addr, int longcnt, struct searchinfo *si)
{
	int i;
	...
	for (i = 0; i < cnt; i++, ptr++, addr += sizeof(int)) {
		for (si->val = 0; si->val < si->vcnt; si->val++) {
			if (SEARCHMASK(*ptr) == SEARCHMASK(si->s_parms.s_uint.value[si->val])) {
				if (si->do_task_header) {
					print_task_header(fp, si->task_context, si->tasks_found);
					si->do_task_header = FALSE;
					si->tasks_found++;
...
/* phys search uses ulonglong address representation */
static ulonglong search_uint_p(ulong * bufptr, ulonglong addr, int longcnt, struct searchinfo *si)
{
	int i;
	int cnt = longcnt * (sizeof(long) / sizeof(int));
	uint *ptr = (uint *) bufptr;
...
static ulong search_ushort(ulong * bufptr, ulong addr, int longcnt, struct searchinfo *si)
{
	int i;
	...
	for (i = 0; i < cnt; i++, ptr++, addr += sizeof(short)) {
		for (si->val = 0; si->val < si->vcnt; si->val++) {
			if (SEARCHMASK(*ptr) == SEARCHMASK(si->s_parms.s_ushort.value[si->val])) {
				if (si->do_task_header) {
					print_task_header(fp, si->task_context, si->tasks_found);
					si->do_task_header = FALSE;
					si->tasks_found++;
...
/* phys search uses ulonglong address representation */
static ulonglong search_ushort_p(ulong * bufptr, ulonglong addr, int longcnt, struct searchinfo *si)
{
	int i;
	int cnt = longcnt * (sizeof(long) / sizeof(short));
	ushort *ptr = (ushort *) bufptr;
...
static void report_match(struct searchinfo *si, ulong addr, char *ptr1, int len1, char *ptr2, int len2)
{
	int i;
...
static ulong search_chars(ulong * bufptr, ulong addr, int longcnt, struct searchinfo *si)
{
	int i, j;
	int len;
	char *target;
			...
			if (cross[j].cnt) {
				...
				for (i = 0; i < len - 1; i++) {
					if (cross[j].hit[i]
						...
						report_match(si,
							     cross[j].addr + i,
							     target, len, &ptr[i + 1], CHARS_CTX - len);
				}
			}
		}
	}
...
static void report_match_p(ulonglong addr, char *ptr1, int len1, char *ptr2, int len2)
{
	int i;
	fprintf(fp, "%llx: ", addr);
	for (i = 0; i < len1; i++) {
...
static ulonglong search_chars_p(ulong * bufptr, ulonglong addr_p, int longcnt, struct searchinfo *si)
{
	int i, j;
	int len;
	char *target;
		...
		for (j = 0; j < si->vcnt; j++) {
			if (cross[j].cnt) {
				...
				for (i = 0; i < len - 1; i++) {
					if (cross[j].hit[i]
					    && !strncmp(&target[len - 1 - i], ptr, i + 1))
						report_match_p(cross[j].addr_p +
							       i, target, len, &ptr[i + 1], CHARS_CTX - len);
				}
			}
		}
	}
...
static void search_virtual(struct searchinfo *si)
{
	ulong start, end;
	ulong pp, next, *ubp;
	...
	for (pp = VIRTPAGEBASE(start); next < end; next = pp) {
		 ...
		 */
		if (XEN_HYPER_MODE()) {
			if (!readmem(pp, KVADDR, pagebuf, PAGESIZE(), "search page", RETURN_ON_ERROR | QUIET)) {
				if (CRASHDEBUG(1))
					fprintf(fp, "search suspended at: %lx\n", pp);
				goto done;
			}
			goto virtual;
		}
		...
		switch (si->memtype) {
		case UVADDR:
			if (!uvtop(CURRENT_CONTEXT(), pp, &paddr, 0) || !phys_to_page(paddr, &page)) {
		...
		case KVADDR:
			if (!kvtop(CURRENT_CONTEXT(), pp, &paddr, 0) || !phys_to_page(paddr, &page)) {
				if (!next_kpage(pp, &pp))
					goto done;
				continue;
			}
		...
		if (!readmem(paddr, PHYSADDR, pagebuf, PAGESIZE(), "search page", RETURN_ON_ERROR | QUIET)) {
			pp += PAGESIZE();
			continue;
		}
 virtual:
...
static void search_physical(struct searchinfo *si)
{
	...
	for (ppp = PHYSPAGEBASE(start_in); pnext < end_in; pnext = ppp) {
		...
		if (!phys_to_page(ppp, &page) ||
		    !readmem(ppp, PHYSADDR, pagebuf, PAGESIZE(), "search page", RETURN_ON_ERROR | QUIET)) {
 ...
 */
static int next_upage(struct task_context *tc, ulong vaddr, ulong * nextvaddr)
{
	ulong vma, total_vm;
	char *vma_buf;
 ...
 */
static int next_vmlist_vaddr(ulong vaddr, ulong * nextvaddr)
{
	int i, retval;
	ulong cnt;
	...
	if (!vmlist) {
		...
		if (vmlist) {
			BCOPY(mi->vmlist, vmlist, sizeof(struct vmlist) * cnt);
			count = cnt;
 ...
 */
int in_vmlist_segment(ulong vaddr)
{
	ulong next;

	if (next_vmlist_vaddr(vaddr, &next) && (vaddr == next))
		return TRUE;
 ...
 */
static int next_module_vaddr(ulong vaddr, ulong * nextvaddr)
{
	int i;
	ulong start, end;
 ...
 */
static int next_kpage(ulong vaddr, ulong * nextvaddr)
{
	ulong vaddr_orig;
 ...
 */
static int next_physpage(ulonglong paddr, ulonglong * nextpaddr)
{
	int n;
...
char *swap_info_hdr = "SWAP_INFO_STRUCT    TYPE       SIZE       USED     PCT  PRI  FILENAME\n";

static int dump_swap_info(ulong swapflags, ulong * totalswap_pages, ulong * totalused_pages)
{
	int i, j;
	...
	for (i = 0; i < vt->nr_swapfiles; i++,
	     swap_info += (vt->flags & SWAPINFO_V1 ? SIZE(swap_info_struct) : sizeof(void *))) {
		if (vt->flags & SWAPINFO_V2) {
			if (!readmem(swap_info, KVADDR, &swap_info_ptr,
				     sizeof(void *), "swap_info pointer", QUIET | RETURN_ON_ERROR))
				continue;
			if (!swap_info_ptr)
				continue;
		...
		if (MEMBER_SIZE("swap_info_struct", "flags") == sizeof(uint))
			flags = UINT(vt->swap_info_struct + OFFSET(swap_info_struct_flags));
		else
			flags = ULONG(vt->swap_info_struct + OFFSET(swap_info_struct_flags));

		if (!(flags & SWP_USED))
			continue;

		swap_file = ULONG(vt->swap_info_struct + OFFSET(swap_info_struct_swap_file));

		swap_device = INT(vt->swap_info_struct +
				  OFFSET_OPTION(swap_info_struct_swap_device, swap_info_struct_old_block_size));

		pages = INT(vt->swap_info_struct + OFFSET(swap_info_struct_pages));
		...
		if (MEMBER_SIZE("swap_info_struct", "prio") == sizeof(short))
			prio = SHORT(vt->swap_info_struct + OFFSET(swap_info_struct_prio));
		else
			prio = INT(vt->swap_info_struct + OFFSET(swap_info_struct_prio));

		if (MEMBER_SIZE("swap_info_struct", "max") == sizeof(int))
			max = UINT(vt->swap_info_struct + OFFSET(swap_info_struct_max));
		else
			max = ULONG(vt->swap_info_struct + OFFSET(swap_info_struct_max));

		if (VALID_MEMBER(swap_info_struct_inuse_pages)) {
			if (MEMBER_SIZE("swap_info_struct", "inuse_pages") == sizeof(int))
				inuse_pages = UINT(vt->swap_info_struct + OFFSET(swap_info_struct_inuse_pages));
			else
				inuse_pages = ULONG(vt->swap_info_struct + OFFSET(swap_info_struct_inuse_pages));
		}

		swap_map = ULONG(vt->swap_info_struct + OFFSET(swap_info_struct_swap_map));

		if (swap_file) {
			if (VALID_MEMBER(swap_info_struct_swap_vfsmnt)) {
				vfsmnt = ULONG(vt->swap_info_struct + OFFSET(swap_info_struct_swap_vfsmnt));
				get_pathname(swap_file, buf, BUFSIZE, 1, vfsmnt);
			} else if (VALID_MEMBER(swap_info_struct_old_block_size)) {
				devname = vfsmount_devname(file_to_vfsmnt(swap_file), buf1, BUFSIZE);
				get_pathname(file_to_dentry(swap_file), buf, BUFSIZE, 1, file_to_vfsmnt(swap_file));
				if ((STREQ(devname, "devtmpfs")
				     || STREQ(devname, "udev"))
				    && !STRNEQ(buf, "/dev/"))
		...
		if (vt->flags & SWAPINFO_V1) {
			...
			if (!readmem(swap_map, KVADDR, smap,
				     sizeof(ushort) * max, "swap_info swap_map data", RETURN_ON_ERROR | QUIET)) {
				if (swapflags & RETURN_ON_ERROR) {
					...
					*totalused_pages = i;
					...
					error(FATAL, "swap_info[%d].swap_map at %lx is inaccessible\n", i, swap_map);
			}
		}
		...
		if (swapflags & VERBOSE) {
			sprintf(buf1, "%lx", (vt->flags & SWAPINFO_V2) ? swap_info_ptr : swap_info);
...
static void swap_info_init(void)
{
	...
	if ((get_symbol_type("swap_info", NULL, req) == TYPE_CODE_ARRAY) &&
	    ((req->target_typecode == TYPE_CODE_PTR) || (req->target_typecode == TYPE_CODE_STRUCT))) {
 ...
 */
char *swap_location(ulonglong pte, char *buf)
{
	...
	if (THIS_KERNEL_VERSION >= LINUX(2, 6, 0))
		sprintf(buf, "%s  OFFSET: %lld", get_swapdev(__swp_type(pte), swapdev), __swp_offset(pte));
	else
		sprintf(buf, "%s  OFFSET: %llx", get_swapdev(SWP_TYPE(pte), swapdev), SWP_OFFSET(pte));
 ...
 */
static char *get_swapdev(ulong type, char *buf)
{
	...
	swap_info_len = (i = ARRAY_LENGTH(swap_info)) ? i : get_array_length("swap_info", NULL, 0);
	...
	case SWAPINFO_V2:
		...
		if (!readmem(swap_info, KVADDR, &swap_info_ptr,
			     sizeof(void *), "swap_info pointer", RETURN_ON_ERROR | QUIET))
			return buf;
		if (!swap_info_ptr)
			return buf;
		fill_swap_info(swap_info_ptr);
 ...
 */
static void fill_swap_info(ulong swap_info)
{
	...
	readmem(swap_info, KVADDR, vt->swap_info_struct, SIZE(swap_info_struct), "fill_swap_info", FAULT_ON_ERROR);
...
static char *vma_file_offset(ulong vma, ulong vaddr, char *buf)
{
	...
	if (VALID_MEMBER(vm_area_struct_vm_offset))
		vm_offset = ULONG(vma_buf + OFFSET(vm_area_struct_vm_offset));
	else if (VALID_MEMBER(vm_area_struct_vm_pgoff))
		vm_pgoff = ULONG(vma_buf + OFFSET(vm_area_struct_vm_pgoff));
	else
		goto no_file_offset;
 ...
 */
static void dump_memory_nodes(int initialize)
{
	int i, j;
	...
	if (initialize) {
		...
		if (symbol_exists("pgdat_list") &&
		    (VALID_MEMBER(pglist_data_node_next) || VALID_MEMBER(pglist_data_pgdat_next))) {
			get_symbol_data("pgdat_list", sizeof(void *), &pgdat);
			vt->flags &= ~NODES_ONLINE;
		} else if (vt->flags & NODES_ONLINE) {
			if ((node = next_online_node(0)) < 0) {
				error(WARNING, "cannot determine first node from node_online_map\n\n");
				return;
			}
			if (!(pgdat = next_online_pgdat(node))) {
				error(WARNING, "cannot determine pgdat list for this kernel/architecture\n\n");
				return;
			}
		}
	} else
	...
	for (n = 0, badaddr = FALSE; pgdat; n++) {
		...
		if (VALID_MEMBER(pglist_data_node_mem_map)) {
			readmem(pgdat + OFFSET(pglist_data_node_mem_map),
				KVADDR, &node_mem_map, sizeof(ulong), "node_mem_map", FAULT_ON_ERROR);
		} else {
		...
		if (VALID_MEMBER(pglist_data_node_start_paddr)) {
			...
			readmem(pgdat + OFFSET(pglist_data_node_start_pfn),
				KVADDR, &node_start_pfn, sizeof(ulong), "pglist node_start_pfn", FAULT_ON_ERROR);
			...
			error(INFO, "cannot determine zone starting physical address\n");

		if (VALID_MEMBER(pglist_data_node_start_mapnr))
			readmem(pgdat + OFFSET(pglist_data_node_start_mapnr),
				KVADDR, &node_start_mapnr, sizeof(ulong), "pglist node_start_mapnr", FAULT_ON_ERROR);

		if (VALID_MEMBER(pglist_data_node_size))
			readmem(pgdat + OFFSET(pglist_data_node_size),
				KVADDR, &node_size, sizeof(ulong), "pglist node_size", FAULT_ON_ERROR);
			...
			error(INFO, "cannot determine zone size\n");
		...
		if (VALID_MEMBER(pglist_data_bdata))
			readmem(pgdat + OFFSET(pglist_data_bdata), KVADDR,
				&bdata, sizeof(ulong), "pglist bdata", FAULT_ON_ERROR);
		else
			bdata = BADADDR;
		...
		if (!initialize) {
			...
			fprintf(fp, "%sNODE  %s  %s  %s  %s\n",
				...
				mkstring(buf2, flen, CENTER | LJUST,
					 "PGLIST_DATA"), mkstring(buf3, flen,
								  CENTER |
								  LJUST,
								  "BOOTMEM_DATA"),
			...
			sprintf(buf5, " %2d   %s  %s  %s  %s\n", id,
				...
				mkstring(buf3, flen, CENTER | LONG_HEX,
					 MKSTR(bdata)), mkstring(buf4, flen,
								 CENTER | LJUST | LONG_HEX, MKSTR(node_zones)));
			fprintf(fp, "%s", buf5);

			j = 12 + strlen(buf1) + strlen(buf2) + strlen(buf3) + count_leading_spaces(buf4);
			...
			fprintf(fp, "%s  %s  %s\n",
				mkstring(buf1, VADDR_PRLEN, CENTER | LONG_HEX,
					 MKSTR(node_mem_map)), mkstring(buf2,
									strlen
									("   START_PADDR  "),
									CENTER |
									LONGLONG_HEX
									...
									(&node_start_paddr)),
				mkstring(buf3, strlen("START_MAPNR"),
					 CENTER | LONG_DEC | RJUST, MKSTR(node_start_mapnr)));

			sprintf(buf2, "%s  %s  START_PADDR  START_MAPNR",
				node_zone_hdr, mkstring(buf1, VADDR_PRLEN, CENTER | RJUST, "MEM_MAP"));
			slen = strlen(buf2);
			fprintf(fp, "\n%s\n", buf2);
		}
		...
		for (i = 0; i < vt->nr_zones; i++) {
			...
			if (VALID_MEMBER(zone_struct_size))
				readmem(node_zones + OFFSET(zone_struct_size),
					KVADDR, &zone_size, sizeof(ulong), "zone_struct size", FAULT_ON_ERROR);
			else if (VALID_MEMBER(zone_struct_memsize)) {
				readmem(node_zones +
					OFFSET(zone_struct_memsize), KVADDR,
					&zone_size, sizeof(ulong), "zone_struct memsize", FAULT_ON_ERROR);
				nt->size += zone_size;
			} else if (VALID_MEMBER(zone_spanned_pages)) {
				readmem(node_zones + OFFSET(zone_spanned_pages),
					KVADDR, &zone_size, sizeof(ulong), "zone spanned_pages", FAULT_ON_ERROR);
			} else
				error(FATAL, "zone_struct has neither size nor memsize field\n");

			readmem(node_zones +
				OFFSET_OPTION(zone_struct_free_pages,
					      zone_free_pages), KVADDR,
				&free_pages, sizeof(ulong), "zone[_struct] free_pages", FAULT_ON_ERROR);
			readmem(node_zones +
				OFFSET_OPTION(zone_struct_name, zone_name),
				KVADDR, &value, sizeof(void *), "zone[_struct] name", FAULT_ON_ERROR);
			if (!read_string(value, buf1, BUFSIZE - 1))
			...
			if (VALID_STRUCT(zone_struct)) {
				if (VALID_MEMBER(zone_struct_zone_start_paddr)) {
					readmem(node_zones + OFFSET
						...
						sizeof(ulong), "node_zones zone_start_paddr", FAULT_ON_ERROR);
				} else {
					readmem(node_zones +
						OFFSET
						(zone_struct_zone_start_pfn),
						KVADDR, &zone_start_pfn,
						sizeof(ulong), "node_zones zone_start_pfn", FAULT_ON_ERROR);
					zone_start_paddr = PTOB(zone_start_pfn);
				}
				readmem(node_zones +
					OFFSET(zone_struct_zone_start_mapnr),
					KVADDR, &zone_start_mapnr,
					sizeof(ulong), "node_zones zone_start_mapnr", FAULT_ON_ERROR);
			} else {
				readmem(node_zones +
				...
				if (IS_SPARSEMEM()) {
					...
					readmem(pgdat +
						...
						KVADDR, &zone_mem_map,
						sizeof(void *), "contig_page_data mem_map", FAULT_ON_ERROR);
					if (zone_size)
					...
					readmem(node_zones +
						...
						KVADDR, &zone_mem_map,
						sizeof(ulong), "node_zones zone_mem_map", FAULT_ON_ERROR);

				if (zone_mem_map)
					zone_start_mapnr = (zone_mem_map - node_mem_map) / SIZE(page);
			...
			if (IS_SPARSEMEM()) {
				...
				if (zone_size) {
				   ...
				   INVALID_MEMBER(zone_struct_zone_mem_map) && INVALID_MEMBER(zone_zone_mem_map)) {
				readmem(pgdat +
			...
			if (!initialize) {
				fprintf(fp, " %2d   %-9s %7ld  ", i, buf1, zone_size);
				...
				fprintf(fp, "%s  %s  %s\n",
					...
					mkstring(buf3, strlen("START_MAPNR"),
						 LONG_DEC | RJUST, MKSTR(zone_start_mapnr)));
			}
 ...
 */
static int verify_pfn(ulong pfn)
{
	int i;
	physaddr_t mask;
	...
	for (n = 0; pgdat; n++) {
		...
		for (i = 0; i < vt->nr_zones; i++) {
			...
			if (!readmem(node_zones, KVADDR, zonebuf,
				     SIZE_OPTION(zone_struct, zone), "zone buffer", FAULT_ON_ERROR))
				break;

			value1 = ULONG(zonebuf + OFFSET_OPTION(zone_struct_name, zone_name));

			if (!read_string(value1, buf1, BUFSIZE - 1))
				sprintf(buf1, "(unknown) ");

			if (VALID_MEMBER(zone_struct_size))
				value1 = value6 = ULONG(zonebuf + OFFSET(zone_struct_size));
			else if (VALID_MEMBER(zone_struct_memsize)) {
				value1 = value6 = ULONG(zonebuf + OFFSET(zone_struct_memsize));
			} else if (VALID_MEMBER(zone_spanned_pages)) {
				value1 = ULONG(zonebuf + OFFSET(zone_spanned_pages));
				value6 = ULONG(zonebuf + OFFSET(zone_present_pages));
			} else
				error(FATAL, "zone struct has unknown size field\n");

			if (VALID_MEMBER(zone_watermark)) {
				if (!enumerator_value("WMARK_MIN", &min) ||
				    !enumerator_value("WMARK_LOW", &low) || !enumerator_value("WMARK_HIGH", &high)) {
					min = 0;
					low = 1;
					high = 2;
				}
				value2 = ULONG(zonebuf + OFFSET(zone_watermark) + (sizeof(long) * min));
				value3 = ULONG(zonebuf + OFFSET(zone_watermark) + (sizeof(long) * low));
				value4 = ULONG(zonebuf + OFFSET(zone_watermark) + (sizeof(long) * high));
			} else {
				value2 = ULONG(zonebuf + OFFSET_OPTION(zone_pages_min, zone_struct_pages_min));
				value3 = ULONG(zonebuf + OFFSET_OPTION(zone_pages_low, zone_struct_pages_low));
				value4 = ULONG(zonebuf + OFFSET_OPTION(zone_pages_high, zone_struct_pages_high));
			}
			...
			fprintf(fp, "  MIN/LOW/HIGH: %ld/%ld/%ld", value2, value3, value4);

			if (VALID_MEMBER(zone_vm_stat))
				dump_vm_stat("NR_FREE_PAGES", (long *)&value5, node_zones + OFFSET(zone_vm_stat));

			if (VALID_MEMBER(zone_nr_active)
			    && VALID_MEMBER(zone_nr_inactive)) {
				value1 = ULONG(zonebuf + OFFSET(zone_nr_active));
				value2 = ULONG(zonebuf + OFFSET(zone_nr_inactive));
				fprintf(fp,
					"\n  NR_ACTIVE: %ld  NR_INACTIVE: %ld  FREE: %ld\n", value1, value2, value5);
				if (VALID_MEMBER(zone_vm_stat)) {
					fprintf(fp, "  VM_STAT:\n");
					dump_vm_stat(NULL, NULL, node_zones + OFFSET(zone_vm_stat));
				}
			} else if (VALID_MEMBER(zone_vm_stat) &&
				   dump_vm_stat("NR_ACTIVE", (long *)&value1, node_zones + OFFSET(zone_vm_stat))
				   && dump_vm_stat("NR_INACTIVE", (long *)&value2, node_zones + OFFSET(zone_vm_stat))) {
				fprintf(fp, "\n  VM_STAT:\n");
				dump_vm_stat(NULL, NULL, node_zones + OFFSET(zone_vm_stat));
			} else {
				if (VALID_MEMBER(zone_vm_stat)) {
			...
			if (VALID_MEMBER(zone_all_unreclaimable)) {
				ivalue = UINT(zonebuf + OFFSET(zone_all_unreclaimable));
				fprintf(fp, "  ALL_UNRECLAIMABLE: %s  ", ivalue ? "yes" : "no");
			} else if (VALID_MEMBER(zone_flags)
				   && enumerator_value("ZONE_ALL_UNRECLAIMABLE", (long *)&value1)) {
				value2 = ULONG(zonebuf + OFFSET(zone_flags));
				value3 = value2 & (1 << value1);
				fprintf(fp, "  ALL_UNRECLAIMABLE: %s  ", value3 ? "yes" : "no");
			}

			if (VALID_MEMBER(zone_pages_scanned)) {
				value1 = ULONG(zonebuf + OFFSET(zone_pages_scanned));
...
static void node_table_init(void)
{
	 ...
	 */
	if ((vt->flags & NODES) && (VALID_MEMBER(pglist_data_node_next) || VALID_MEMBER(pglist_data_pgdat_next))) {
	...
	if (!(vt->node_table = (struct node_table *)
		...
		error(FATAL, "cannot malloc node_table %s(%d nodes)", vt->numnodes > 1 ? "array " : "", vt->numnodes);

	BZERO(vt->node_table, sizeof(struct node_table) * vt->numnodes);

	dump_memory_nodes(MEMORY_NODES_INITIALIZE);

	qsort((void *)vt->node_table, (size_t) vt->numnodes, sizeof(struct node_table), compare_node_data);
...
static int compare_node_data(const void *v1, const void *v2)
{
	...
	return (t1->node_id < t2->node_id ? -1 : t1->node_id == t2->node_id ? 0 : 1);
}
...
ulong first_vmalloc_address(void)
{
	...
	if (vt->flags & USE_VMAP_AREA) {
		...
		if (!readmem(vm_struct + OFFSET(vm_struct_addr), KVADDR,
			     &vmalloc_start, sizeof(void *), "first vmlist addr", RETURN_ON_ERROR))
			non_matching_kernel();
	}
 ...
 */
static int next_identity_mapping(ulong vaddr, ulong * nextvaddr)
{
	int n, retval;
	struct node_table *nt;
...
int l1_cache_size(void)
{
	...
	if (VALID_MEMBER(kmem_cache_s_c_align)) {
		...
		readmem(cache + OFFSET(kmem_cache_s_c_align),
			KVADDR, &c_align, sizeof(ulong), "c_align", FAULT_ON_ERROR);
		retval = (int)c_align;
	} else if (VALID_MEMBER(kmem_cache_s_colour_off)) {
		cache = symbol_value("cache_cache");
		readmem(cache + OFFSET(kmem_cache_s_colour_off),
			KVADDR, &colour_off, sizeof(int), "colour_off", FAULT_ON_ERROR);
		retval = colour_off;
	}
...
{
	return coded_mem_map + (section_nr_to_pfn(section_nr) * SIZE(page));
}
...
void sparse_mem_init(void)
{
	...
	if (!MAX_PHYSMEM_BITS())
		error(FATAL, "CONFIG_SPARSEMEM kernels not supported for this architecture\n");
	...
	readmem(addr, KVADDR, vt->mem_sec, mem_section_size, "memory section root table", FAULT_ON_ERROR);
}

char *read_mem_section(ulong addr)
{
	if ((addr == 0) || !IS_KVADDR(addr))
		return 0;

	readmem(addr, KVADDR, vt->mem_section, SIZE(mem_section), "memory section", FAULT_ON_ERROR);

	return vt->mem_section;
}

ulong nr_to_section(ulong nr)
{
	ulong addr;
	...
	if (IS_SPARSEMEM_EX()) {
		if (SECTION_NR_TO_ROOT(nr) >= NR_SECTION_ROOTS()) {
			if (!STREQ(pc->curcmd, "rd") && !STREQ(pc->curcmd, "search")
			    && !STREQ(pc->curcmd, "kmem"))
				error(WARNING, "sparsemem: invalid section number: %ld\n", nr);
			return 0;
		}
	}

	if (IS_SPARSEMEM_EX()) {
		if ((mem_sec[SECTION_NR_TO_ROOT(nr)] == 0) || !IS_KVADDR(mem_sec[SECTION_NR_TO_ROOT(nr)]))
			return 0;
		addr = mem_sec[SECTION_NR_TO_ROOT(nr)] + (nr & SECTION_ROOT_MASK()) * SIZE(mem_section);
	} else
		addr = symbol_value("mem_section") +
		    (SECTIONS_PER_ROOT() * SECTION_NR_TO_ROOT(nr) + (nr & SECTION_ROOT_MASK())) * SIZE(mem_section);
...
int valid_section(ulong addr)
{
	...
	if ((mem_section = read_mem_section(addr)))
		return (ULONG(mem_section + OFFSET(mem_section_section_mem_map)) && SECTION_MARKED_PRESENT);
	return 0;
}
...
ulong pfn_to_map(ulong pfn)
{
	...
	if (section_has_mem_map(section)) {
		...
		mem_map = sparse_decode_mem_map(coded_mem_map, section_nr) + (page_offset * SIZE(page));
		return mem_map;
	}
...
void dump_mem_sections(void)
{
	...
	fprintf(fp, "\n\nNR  %s  %s  %s  PFN\n",
		...
		mkstring(buf2, MAX(VADDR_PRLEN, strlen("CODED_MEM_MAP")),
			 CENTER | LJUST, "CODED_MEM_MAP"), mkstring(buf3, VADDR_PRLEN, CENTER | LJUST, "MEM_MAP"));
		...
		if ((addr = valid_section_nr(nr))) {
			...
			fprintf(fp, "%2ld  %s  %s  %s  %s\n",
				...
				mkstring(buf2, MAX(VADDR_PRLEN,
					 ...
					 MKSTR(coded_mem_map)), mkstring(buf3,
									 VADDR_PRLEN,
									 CENTER
									 |
									 LONG_HEX
									 ...
									 MKSTR
									 (mem_map)),
				pc->output_radix == 10 ? mkstring(buf4,
								  VADDR_PRLEN,
								  LONG_DEC |
								  LJUST,
								  MKSTR(pfn)) :
				mkstring(buf4, VADDR_PRLEN, LONG_HEX | LJUST, MKSTR(pfn)));
		}
	}
}
	...
	for (nr = 0; nr <= nr_mem_sections; nr++) {
		if ((addr = valid_section_nr(nr))) {
			...
			fprintf(fp,
				...
				nr,
				addr, coded_mem_map, section_nr_to_pfn(nr), sparse_decode_mem_map(coded_mem_map, nr));
		}
	}
}
...
static int get_nodes_online(void)
{
	...
	if (!symbol_exists("node_online_map") && !symbol_exists("node_states"))
		return 0;
	...
	if (!readmem(mapaddr, KVADDR, (void *)&vt->node_online_map[0], len, "node_online_map", QUIET | RETURN_ON_ERROR))
 ...
 */
static int next_online_node(int first)
{
	int i, j, node;
	ulong mask, *maskptr;
 ...
 */
static ulong next_online_pgdat(int node)
{
	char buf[BUFSIZE];
	ulong pgdat;
	...
	if (LKCD_KERNTYPES()) {
		...
		if ((!strstr(buf, "struct pglist_data *") &&
		     !strstr(buf, "pg_data_t *")) || (count_chars(buf, '[') != 1)
		    || (count_chars(buf, ']') != 1))
			goto pgdat2;
	}
 ...
 pgdat2:
	...
	if (!readmem(symbol_value("pgdat_list") + (node * sizeof(void *)),
		     KVADDR, &pgdat, sizeof(void *), "pgdat_list", RETURN_ON_ERROR) || !IS_KVADDR(pgdat))
		goto pgdat3;
...
static int vm_stat_init(void)
{
	...
	if (LKCD_KERNTYPES()) {
		...
		if (!symbol_exists("vm_stat") || get_symbol_type("vm_stat", NULL, NULL) != TYPE_CODE_ARRAY)
			goto bailout;
	...
	while (fgets(buf, BUFSIZE, pc->tmpfile)) {
		...
		if (STREQ(arglist[0], "NR_VM_ZONE_STAT_ITEMS")) {
			if (LKCD_KERNTYPES())
				vt->nr_vm_stat_items = MAX(atoi(arglist[2]), count);
			break;
		} else {
	...
	total = stringlen + vt->nr_vm_stat_items + (sizeof(void *) * vt->nr_vm_stat_items);
 ...
 */
static int dump_vm_stat(char *item, long *retval, ulong zone)
{
	char *buf;
	ulong *vp;
	ulong location;
	...
	if (!vm_stat_init()) {
		if (!item)
			if (CRASHDEBUG(1))
				error(INFO, "vm_stat not available in this kernel\n");
		return FALSE;
	}
	...
	readmem(location, KVADDR, buf, sizeof(ulong) * vt->nr_vm_stat_items, "vm_stat", FAULT_ON_ERROR);
	...
	if (!item) {
		...
		for (i = 0; i < vt->nr_vm_stat_items; i++)
			fprintf(fp, "%s%s: %ld\n",
				space(maxlen - strlen(vt->vm_stat_items[i])), vt->vm_stat_items[i], vp[i]);
		return TRUE;
	}
...
int dump_page_states(void)
{
	...
	if (!(sp = per_cpu_symbol_search("per_cpu__page_states"))) {
		if (CRASHDEBUG(1))
			error(INFO, "per_cpu__page_states" "not available in this kernel\n");
		return FALSE;
	}
	...
	rewind(pc->tmpfile);
	while (fgets(buf, BUFSIZE, pc->tmpfile)) {
		if (strstr(buf, "struct page_state") || strstr(buf, "}"))
			continue;
		members++;
	}
...
static int dump_vm_event_state(void)
{
	...
	for (c = 0; c < kt->cpus; c++) {
		...
		readmem(addr, KVADDR, events,
			sizeof(ulong) * vt->nr_vm_event_items, "vm_event_states buffer", FAULT_ON_ERROR);
		for (i = 0; i < vt->nr_vm_event_items; i++)
	...
	for (i = 0; i < vt->nr_vm_event_items; i++)
		fprintf(fp, "%s%s: %ld\n",
			space(maxlen - strlen(vt->vm_event_items[i])), vt->vm_event_items[i], cumulative[i]);
...
static int vm_event_state_init(void)
{
	...
	if ((vt->nr_vm_event_items == -1) || !per_cpu_symbol_search("per_cpu__vm_event_states"))
		goto bailout;
	...
	total = stringlen + vt->nr_vm_event_items + (sizeof(void *) * vt->nr_vm_event_items);
 ...
 */
void dump_page_flags(ulonglong flags)
{
	int c ATTRIBUTE_UNUSED;
		...
		while (fgets(buf1, BUFSIZE, pc->tmpfile)) {
			if (strstr(buf1, " = ")) {
				...
				if ((sz = strlen(arglist[0])) > longest)
					longest = sz;
				if (strstr(arglist[0], "PG_") && ((val = atoi(arglist[2])) > largest))
					largest = val;
			}
		}
	} else
			...
			if (!flags || (flags & tmpflag)) {
				fprintf(pc->saved_fp, "%s%s  %2d  %.*lx\n",
					...
					mkstring(buf2, longest, LJUST,
						 arglist[0]), val, largest, (ulong) (1ULL << val));
				if (flags & tmpflag)
					found++;
			}
...
static void kmem_cache_init_slub(void)
{
	if (CRASHDEBUG(1) && !(vt->flags & CONFIG_NUMA) && (vt->numnodes > 1))
		error(WARNING, "kmem_cache_init_slub: numnodes: %d without CONFIG_NUMA\n", vt->numnodes);
...
static void kmem_cache_list_common(void)
{
	...
	for (i = 0; i < cnt; i++) {
		...
		readmem(cache_list[i] + OFFSET(kmem_cache_name),
			KVADDR, &name, sizeof(char *), "kmem_cache.name", FAULT_ON_ERROR);
...
static void dump_kmem_cache_info_slub(struct meminfo *si)
{
	char b1[BUFSIZE];
	char b2[BUFSIZE];
	int namelen, sizelen, spacelen;
	...
	if (namelen++ > 18) {
		spacelen = 29 - namelen - sizelen;
		fprintf(fp, "%s%s%ld  ", si->curname, space(spacelen <= 0 ? 1 : spacelen), si->objsize);
		if (spacelen > 0)
			spacelen = 1;
		sprintf(b1, "%c%dld  ", '%', 9 + spacelen - 1);
	} else {
	...
	fprintf(fp, "%8ld  %5ld  %4ldk\n", si->num_slabs * si->objects, si->num_slabs, si->slabsize / 1024);
}

static void dump_kmem_cache_slub(struct meminfo *si)
{
	int i;
	ulong name, oo;
	...
	for (i = 0; i < si->cache_count; i++) {
		...
		if (!readmem(si->cache_list[i], KVADDR, si->cache_buf,
			     SIZE(kmem_cache), "kmem_cache buffer", RETURN_ON_ERROR | RETURN_PARTIAL))
			goto next_cache;
		...
		if (VALID_MEMBER(kmem_cache_objects)) {
			...
			error(FATAL, "cannot determine " "kmem_cache objects/order values\n");
		...
		if (!get_kmem_cache_slub_data(GET_SLUB_SLABS, si) || !get_kmem_cache_slub_data(GET_SLUB_OBJECTS, si))
			goto next_cache;
 ...
 */
static int get_kmem_cache_slub_data(long cmd, struct meminfo *si)
{
	int i, n, node;
	...
	for (i = 0; i < kt->cpus; i++) {
		...
		case GET_SLUB_OBJECTS:
			if (!readmem(cpu_slab_ptr + OFFSET(page_inuse),
				     KVADDR, &inuse, sizeof(short), "page inuse", RETURN_ON_ERROR))
				return FALSE;
			total_objects += inuse;
			break;
	...
	for (n = 0; n < vt->numnodes; n++) {
		if (vt->flags & CONFIG_NUMA) {
			nt = &vt->node_table[n];
			node_ptr = ULONG(si->cache_buf + OFFSET(kmem_cache_node) + (sizeof(void *) * nt->node_id));
		} else
		...
		if (!readmem(node_ptr + OFFSET(kmem_cache_node_nr_partial),
			     KVADDR, &node_nr_partial, sizeof(ulong), "kmem_cache_node nr_partial", RETURN_ON_ERROR))
			goto bailout;
		if (!readmem(node_ptr + OFFSET(kmem_cache_node_nr_slabs),
			     KVADDR, &node_nr_slabs, sizeof(ulong), "kmem_cache_node nr_slabs", RETURN_ON_ERROR))
			goto bailout;
...
static void do_kmem_cache_slub(struct meminfo *si)
{
	int i, n;
	ulong cpu_slab_ptr, node_ptr;
	ulong node_nr_partial, node_nr_slabs;
	...
	for (n = 0; n < vt->numnodes; n++) {
		...
		if (node_ptr) {
			if (!readmem
			    (node_ptr + OFFSET(kmem_cache_node_nr_partial),
			     KVADDR, &node_nr_partial, sizeof(ulong), "kmem_cache_node nr_partial", RETURN_ON_ERROR))
				break;
			if (!readmem
			    (node_ptr + OFFSET(kmem_cache_node_nr_slabs),
			     KVADDR, &node_nr_slabs, sizeof(ulong), "kmem_cache_node nr_slabs", RETURN_ON_ERROR))
				break;
		} else
...
static void do_slab_slub(struct meminfo *si, int verbose)
{
	physaddr_t paddr;
	ulong vaddr;
	...
	if (!page_to_phys(si->slab, &paddr)) {
		error(WARNING, "%lx: cannot translate slab page to physical address\n", si->slab);
		return;
	}
	...
	if (!readmem(si->slab + OFFSET(page_inuse), KVADDR, &inuse, sizeof(ushort), "page.inuse", RETURN_ON_ERROR))
		return;
	...
	if (VALID_MEMBER(page_objects)) {
		...
		if (CRASHDEBUG(1) && (objects != si->objects))
			error(NOTE, "%s: slab: %lx oo objects: %ld "
			      "slab objects: %d\n", si->curname, si->slab, si->objects, objects);
	} else
...
#define PAGE_MAPPING_ANON  1
	...
	if (CRASHDEBUG(1)) {
		...
		for (q = freelist; q; q = get_freepointer(si, (void *)q)) {
			if (q & PAGE_MAPPING_ANON) {
				fprintf(fp, "< SLUB: free list END: %lx (%d found) >\n", q, i);
				break;
			}
			fprintf(fp, "   %lx\n", q);
			i++;
	...
	for (p = vaddr; p < vaddr + objects * si->size; p += si->size) {
		is_free = FALSE;
		for (is_free = 0, q = freelist; q; q = get_freepointer(si, (void *)q)) {
			if (q == BADADDR)
				return;
			if (q & PAGE_MAPPING_ANON)
				break;
...
static int count_free_objects(struct meminfo *si, ulong freelist)
{
	int c;
	ulong q;
...
static ulong get_freepointer(struct meminfo *si, void *object)
{
	ulong vaddr, nextfree;

	vaddr = (ulong) (object + si->slab_offset);
	if (!readmem(vaddr, KVADDR, &nextfree, sizeof(void *), "get_freepointer", RETURN_ON_ERROR))
		return BADADDR;

	return nextfree;
}

static void do_node_lists_slub(struct meminfo *si, ulong node_ptr, int node)
{
	...
	if (!readmem(list_head, KVADDR, &next, sizeof(ulong), "kmem_cache_node partial", RETURN_ON_ERROR))
		return;
	...
	while (next != list_head) {
		...
		if (!readmem(next, KVADDR, &next, sizeof(ulong), "page.lru.next", RETURN_ON_ERROR))
			return;
...
#define SLAB_STORE_USER (0x00010000UL)
	...
	if (INVALID_MEMBER(kmem_cache_node_full) || !(flags & SLAB_STORE_USER)) {
...
static char *is_kmem_cache_addr_slub(ulong vaddr, char *kbuf)
{
	int i, cnt;
	ulong *cache_list;
	ulong name;
	...
	for (i = 0, found = FALSE; i < cnt; i++) {
		...
		if (!readmem(cache_list[i] + OFFSET(kmem_cache_name),
			     KVADDR, &name, sizeof(char *), "kmem_cache.name", RETURN_ON_ERROR))
			break;
 ...
 */
static int page_to_nid(ulong page)
{
	int i;
	physaddr_t paddr;
	struct node_table *nt;
	...
	for (i = 0; i < vt->numnodes; i++) {
		...
		end_paddr = nt->start_paddr + ((physaddr_t) nt->size * (physaddr_t) PAGESIZE());
 ...
 */
static int get_kmem_cache_list(ulong ** cache_buf)
{
	int cnt;
	ulong vaddr;
	struct list_data list_data, *ld;
 ...
 */
static ulong compound_head(ulong page)
{
	ulong flags, first_page;;

	first_page = page;

	if (!readmem(page + OFFSET(page_flags), KVADDR, &flags, sizeof(ulong), "page.flags", RETURN_ON_ERROR))
		return first_page;
...
long count_partial(ulong node, struct meminfo *si)
{
	...
	while (next != list_head) {
		...
		if (!hq_enter(next)) {
			error(INFO, "%s: partial list: list corrupt: recurses back onto itself\n", si->curname);
			hq_close();
			return -1;
		}
	}
...
char *is_slab_page(struct meminfo *si, char *buf)
{
	int i, cnt;
	...
	if (!readmem(si->spec_addr + OFFSET(page_flags), KVADDR,
		     &page_flags, sizeof(ulong), "page.flags", RETURN_ON_ERROR | QUIET))
		return NULL;
	...
	if (!readmem(si->spec_addr + OFFSET(page_slab), KVADDR,
		     &page_slab, sizeof(ulong), "page.slab", RETURN_ON_ERROR | QUIET))
		return NULL;
 ...
 *  if requested.
 */
static ulong get_cpu_slab_ptr(struct meminfo *si, int cpu, ulong * cpu_freelist)
{
	...
	case TYPE_CODE_STRUCT:
		cpu_slab_ptr = ULONG(si->cache_buf + OFFSET(kmem_cache_cpu_slab) + OFFSET(kmem_cache_cpu_page));
		if (cpu_freelist && VALID_MEMBER(kmem_cache_cpu_freelist))
			*cpu_freelist = ULONG(si->cache_buf +
					      OFFSET(kmem_cache_cpu_slab) + OFFSET(kmem_cache_cpu_freelist));
		break;

	case TYPE_CODE_ARRAY:
		cpu_slab_ptr = ULONG(si->cache_buf + OFFSET(kmem_cache_cpu_slab) + (sizeof(void *) * cpu));

		if (cpu_slab_ptr && cpu_freelist && VALID_MEMBER(kmem_cache_cpu_freelist)) {
			if (readmem
			    (cpu_slab_ptr + OFFSET(kmem_cache_cpu_freelist),
			     KVADDR, &freelist, sizeof(void *), "kmem_cache_cpu.freelist", RETURN_ON_ERROR))
				*cpu_freelist = freelist;
		}

		if (cpu_slab_ptr && VALID_MEMBER(kmem_cache_cpu_page)) {
			if (!readmem(cpu_slab_ptr + OFFSET(kmem_cache_cpu_page),
				     KVADDR, &page, sizeof(void *), "kmem_cache_cpu.page", RETURN_ON_ERROR))
				cpu_slab_ptr = 0;
			else
				cpu_slab_ptr = page;
		}
	...
	case TYPE_CODE_PTR:
		cpu_slab_ptr = ULONG(si->cache_buf + OFFSET(kmem_cache_cpu_slab)) + kt->__per_cpu_offset[cpu];
...
#ifdef NOT_USED
ulong slab_to_kmem_cache_node(struct meminfo * si, ulong slab_page)
{
	int node;
	ulong node_ptr;
	...
	if (vt->flags & CONFIG_NUMA) {
		...
		node_ptr = ULONG(si->cache_buf + OFFSET(kmem_cache_node) + (sizeof(void *) * node));
	} else
		node_ptr = si->cache + OFFSET(kmem_cache_local_node);
...
ulong get_kmem_cache_by_name(char *request)
{
	int i, cnt;
	ulong *cache_list;
	ulong name;
