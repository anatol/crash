...
static unsigned char *unw_decode_x1(unsigned char *dp, unsigned char code, void *arg)
{
...
static unsigned char *unw_decode_x2(unsigned char *dp, unsigned char code, void *arg)
{
...
static unsigned char *unw_decode_x3(unsigned char *dp, unsigned char code, void *arg)
{
...
static unsigned char *unw_decode_x4(unsigned char *dp, unsigned char code, void *arg)
{
...
static unsigned char *unw_decode_p2_p5(unsigned char *dp, unsigned char code, void *arg)
{
	if ((code & 0x10) == 0) {
		...
		UNW_DEC_BR_GR(P2, ((code & 0xf) << 1) | ((byte1 >> 7) & 1), (byte1 & 0x7f), arg);
	} else if ((code & 0x08) == 0) {
 ...
 */
static inline unsigned char *unw_decode(unsigned char *dp, int inside_body, void *arg)
{
	unw_decoder decoder;
	unsigned char code;
