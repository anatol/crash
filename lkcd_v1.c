 ...
 */
int lkcd_dump_init_v1(FILE * fp, int fd)
{
	int i;
	int eof;
	uint32_t pgcnt;
 ...
 */
void dump_dump_page_v1(char *s, void *dpp)
{
	dump_page_t *dp;
	uint32_t flags;
	int others;
 ...
 */
void dump_lkcd_environment_v1(ulong arg)
{
	int others;
	dump_header_t *dh;
	dump_page_t *dp;
 ...
 dump_header_only:
	...
	lkcd_print(" dh_magic_number: %llx  ", dh->dh_magic_number);
